  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🌟 Complete IT Solutions</h1>
          <p className="text-sm text-muted-foreground">
            The complete Skyler Blue IT Resolutions package — everything your
            Arkansas business needs in one place
          </p>
        </div>
