...
export default function ShadowITEnterpriseData() {
  ...
  const items = [
    ...
    },
    {
      icon: "🤖",
      title: "AI-Ready",
      desc: "Prepare data for AI models",
      badge: "Future",
    },
    {
      icon: "⚡",
    ...
    },
    {
      icon: "🔐",
      title: "Governance",
      desc: "Data security and compliance",
      badge: "Safe",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Data warehouse · Analytics · BI · AI-ready data · Arkansas
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Turn your data into your biggest asset.
          </p>
