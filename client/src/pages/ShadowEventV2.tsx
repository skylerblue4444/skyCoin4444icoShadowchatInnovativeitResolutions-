  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Advanced crypto events platform with NFT tickets, virtual
            attendance, and DAO meetups
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">2.4M USD</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("Events V2 activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Opening Events V2 docs...")}
          >
