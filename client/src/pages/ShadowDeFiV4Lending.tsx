...
export default function ShadowDeFiV4Lending() {
  ...
  const items = [
    ...
    { icon: "⚡", title: "Instant", desc: "Funds in seconds", badge: "Fast" },
    {
      ...
      desc: "Auto-repay to avoid liquidation",
      badge: "Protected",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 collateral bonus",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black tracking-tight">
          DeFi V4 Lending Protocol
        </h1>
        <p className="text-xs text-muted-foreground mt-0.5">
          Borrow against crypto · No credit check · Instant · SKY4444 collateral
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Borrow against your crypto instantly.
          </p>
