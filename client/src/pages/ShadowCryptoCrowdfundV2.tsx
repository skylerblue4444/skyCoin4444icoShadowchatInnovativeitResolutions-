  ...
  const items = [
    {
      icon: "💰",
      title: "Raise Money",
      desc: "Raise from crypto community",
      badge: "Fund",
    },
    {
      icon: "🎁",
      title: "Rewards",
      desc: "Offer SKY4444 rewards",
      badge: "Incentive",
    },
    {
      icon: "📊",
      title: "Transparent",
      desc: "All funding on-chain",
      badge: "Open",
    },
    {
      icon: "🌍",
      title: "Global",
      desc: "Raise from anywhere",
      badge: "Universal",
    },
    {
      icon: "⚖️",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Raise money from the community · SKY4444 · Rewards
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Raise money from the crypto community.
          </p>
