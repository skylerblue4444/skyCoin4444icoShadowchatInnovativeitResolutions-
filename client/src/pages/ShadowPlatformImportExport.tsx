  ...
  const items = [
    {
      icon: "📥",
      title: "Import",
      desc: "Import from 50+ exchanges",
      badge: "Easy",
    },
    {
      icon: "📤",
      title: "Export",
      desc: "Export to Excel CSV JSON",
      badge: "Flexible",
    },
    {
      icon: "💰",
      title: "Tax Export",
      desc: "Export for tax software",
      badge: "Compliant",
    },
    {
      icon: "🔄",
      title: "Sync",
      desc: "Auto-sync with exchanges",
      badge: "Automatic",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 transactions included",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Import from Coinbase Binance · Export to Excel CSV · Tax tools
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Your complete transaction history, anywhere.
          </p>
