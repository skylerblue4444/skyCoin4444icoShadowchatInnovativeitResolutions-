  ...
  const items = [
    {
      icon: "🚀",
      title: "Latest",
      desc: "Most recent platform updates",
      badge: "Fresh",
    },
    {
      icon: "✨",
      title: "Features",
      desc: "New feature releases",
      badge: "Exciting",
    },
    {
      icon: "🐛",
      title: "Bug Fixes",
      desc: "Issues we squashed",
      badge: "Quality",
    },
    {
      icon: "⚡",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Every update every improvement every fix · Full history
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            See everything we've built and shipped.
          </p>
