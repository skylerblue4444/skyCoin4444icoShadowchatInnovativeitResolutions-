  ...
  const items = [
    {
      icon: "🔑",
      title: "API Keys",
      desc: "Create and manage keys",
      badge: "Access",
    },
    {
      icon: "🔗",
      title: "Webhooks",
      desc: "Real-time event callbacks",
      badge: "Reactive",
    },
    {
      icon: "📊",
      title: "Rate Limits",
      desc: "Monitor API usage",
      badge: "Aware",
    },
    {
      icon: "📄",
    ...
    },
    {
      icon: "🔐",
      title: "Permissions",
      desc: "Scoped API permissions",
      badge: "Secure",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 API endpoints",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Manage API keys · Webhooks · Rate limits · Documentation
        </p>
      </div>
