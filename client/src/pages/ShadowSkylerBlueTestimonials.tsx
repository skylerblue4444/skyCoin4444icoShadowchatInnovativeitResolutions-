...
export default function ShadowSkylerBlueTestimonials() {
  ...
  const items = [
    ...
    },
    {
      ...
      desc: "SMB and enterprise clients",
      badge: "Diverse",
    },
    {
      icon: "🏥",
      title: "Healthcare",
      desc: "HIPAA-compliant IT solutions",
      badge: "Specialized",
    },
    {
      icon: "🏫",
      title: "Education",
      desc: "School district IT support",
      badge: "Community",
    },
    {
      icon: "🏛️",
      title: "Government",
      desc: "Government IT contracts",
      badge: "Trusted",
    },
    {
      icon: "📞",
      title: "Review",
      desc: "479-406-7123 to leave review",
      badge: "Feedback",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          What clients say about Skyler Blue IT Resolutions
        </p>
      </div>
