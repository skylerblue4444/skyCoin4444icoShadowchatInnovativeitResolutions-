    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Official SkyCoin4444 whitepaper covering technology, economics, and
            vision
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">44</p>
            <p className="text-xs text-muted-foreground">Pages</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">4.4.4</p>
            <p className="text-xs text-muted-foreground">Version</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">EN/ES/ZH</p>
            <p className="text-xs text-muted-foreground">Language</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">2024</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-yellow-900/40 to-orange-900/40 border border-yellow-500/30 p-4">
        <p className="font-black text-sm mb-1">
          SKY4444 Whitepaper — Explore Now
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("SKY4444 Whitepaper activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Opening SKY4444 Whitepaper docs...")}
          >
