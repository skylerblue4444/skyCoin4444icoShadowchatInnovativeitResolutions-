  ...
  const items = [
    {
      icon: "💳",
      title: "Visa Card",
      desc: "Accepted at 80M merchants",
      badge: "Universal",
    },
    {
      icon: "💰",
      title: "4.44% Back",
      desc: "Cashback in SKY4444",
      badge: "Rewarding",
    },
    {
      icon: "⚡",
      title: "Instant Convert",
      desc: "Crypto to USD at checkout",
      badge: "Seamless",
    },
    {
      icon: "🌍",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Cashback always in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Spend crypto anywhere Visa is accepted · 4.44% cashback
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Spend your crypto in the real world.
          </p>
