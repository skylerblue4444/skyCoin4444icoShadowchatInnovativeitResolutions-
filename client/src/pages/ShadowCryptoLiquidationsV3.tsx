...
export default function ShadowCryptoLiquidationsV3() {
  ...
  const items = [
    ...
    },
    {
      icon: "🌊",
      title: "Cascades",
      desc: "Identify cascade risks",
      badge: "Warning",
    },
    {
      icon: "📊",
      title: "By Exchange",
      desc: "Liquidations by exchange",
      badge: "Breakdown",
    },
    {
      icon: "🔔",
      title: "Alerts",
      desc: "Alert on large liquidations",
      badge: "First",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Real-time liquidations · Heatmap · Cascades · Risk levels
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Know where the liquidations are before they happen.
          </p>
