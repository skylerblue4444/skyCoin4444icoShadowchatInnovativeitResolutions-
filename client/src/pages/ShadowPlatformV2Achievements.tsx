  ...
  const items = [
    {
      icon: "🥇",
      title: "Gold Badges",
      desc: "Highest achievement tier",
      badge: "Elite",
    },
    {
      icon: "🥈",
      title: "Silver Badges",
      desc: "Mid-tier achievements",
      badge: "Progress",
    },
    {
      icon: "🥉",
      title: "Bronze Badges",
      desc: "Entry-level achievements",
      badge: "Start",
    },
    {
      icon: "⛏️",
      title: "Miner Badge",
      desc: "Mine your first SKY4444",
      badge: "Milestone",
    },
    {
      icon: "💰",
    ...
    },
    {
      icon: "🌍",
      title: "Global Badge",
      desc: "Connect with 10 countries",
      badge: "Social",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Unlock badges · Level up · Show off your crypto journey
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Every action earns you recognition.
          </p>
