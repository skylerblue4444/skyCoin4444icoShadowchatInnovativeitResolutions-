  ...
  const items = [
    {
      icon: "⚡",
      title: "1000 req/sec",
      desc: "Highest rate limits",
      badge: "Fast",
    },
    {
      icon: "🔌",
      title: "WebSocket",
      desc: "Real-time streaming data",
      badge: "Live",
    },
    {
      icon: "📡",
      title: "REST API",
      desc: "Standard REST endpoints",
      badge: "Compatible",
    },
    {
      icon: "📊",
      title: "Historical",
      desc: "10 years of historical data",
      badge: "Complete",
    },
    {
      icon: "🔐",
      title: "Auth",
      desc: "API key and OAuth 2.0",
      badge: "Secure",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 data endpoints",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Fastest crypto API · WebSocket · REST · 1000 req/sec
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Build anything on ShadowChat's API.
          </p>
