  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Decentralized skills marketplace connecting learners with experts
            and employers
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">84 USD</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">
          Skills Marketplace — Activate Now
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("Skills Marketplace activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Opening Skills Marketplace docs...")}
          >
