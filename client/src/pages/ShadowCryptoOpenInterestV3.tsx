  ...
  const items = [
    {
      icon: "📊",
      title: "Total OI",
      desc: "Total open interest",
      badge: "Scale",
    },
    {
      icon: "🏦",
      title: "By Exchange",
      desc: "OI breakdown by exchange",
      badge: "Detail",
    },
    {
      icon: "📅",
      title: "Futures vs Perps",
      desc: "Dated vs perpetual OI",
      badge: "Compare",
    },
    {
      icon: "⚖️",
    ...
    },
    {
      icon: "📈",
      title: "OI Change",
      desc: "OI change over time",
      badge: "Direction",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 open interest",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          OI by exchange · Futures vs perps · Long/short ratio
        </p>
      </div>
