  ...
  const items = [
    {
      icon: "⚡",
      title: "No Collateral",
      desc: "Borrow without collateral",
      badge: "Unique",
    },
    {
      icon: "🔄",
      title: "Same TX",
      desc: "Repay in same transaction",
      badge: "Atomic",
    },
    {
      icon: "💰",
      title: "Arbitrage",
      desc: "Profit from price differences",
      badge: "Opportunity",
    },
    {
      icon: "🔧",
    ...
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Flash loan volume data",
      badge: "Transparent",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Flash loan fees in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Uncollateralized loans · Repay in same transaction · Arbitrage
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The most powerful DeFi primitive.
          </p>
