  ...
  const items = [
    {
      icon: "🤖",
      title: "AI Curated",
      desc: "AI selects most important news",
      badge: "Smart",
    },
    {
      icon: "😊",
    ...
    },
    {
      icon: "🎯",
      title: "Personalized",
      desc: "News for your portfolio",
      badge: "Relevant",
    },
    {
      icon: "⚡",
      title: "Real-Time",
      desc: "Breaking news instantly",
      badge: "First",
    },
    {
      icon: "🌍",
      title: "Global",
      desc: "News from 200+ sources",
      badge: "Comprehensive",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          AI-curated news · Sentiment scored · Personalized · Real-time
        </p>
      </div>
