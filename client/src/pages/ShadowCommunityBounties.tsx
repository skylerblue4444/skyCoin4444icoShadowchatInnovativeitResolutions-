  ...
  const items = [
    {
      icon: "🐛",
      title: "Find Bugs",
      desc: "Report security vulnerabilities",
      badge: "Protect",
    },
    {
      icon: "💰",
      title: "Up to $100K",
      desc: "Critical bugs earn $100K",
      badge: "Lucrative",
    },
    {
      icon: "🔐",
    ...
    },
    {
      icon: "📊",
      title: "Severity",
      desc: "P1 P2 P3 severity tiers",
      badge: "Structured",
    },
    {
      icon: "⚡",
      title: "Fast Pay",
      desc: "Paid within 48 hours",
      badge: "Quick",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "All bounties in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Find bugs earn SKY4444 · Up to $100K per critical bug
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Help secure ShadowChat. Get paid well.
          </p>
