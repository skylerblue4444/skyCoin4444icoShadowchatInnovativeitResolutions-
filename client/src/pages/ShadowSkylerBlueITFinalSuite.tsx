  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🏆 Complete IT Suite</h1>
          <p className="text-sm text-muted-foreground">
            The ultimate Skyler Blue IT Resolutions suite — every service, every
            solution, maximum value for Arkansas
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">Month-to-Month</p>
            <p className="text-xs text-muted-foreground">Contract</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">100% Uptime</p>
