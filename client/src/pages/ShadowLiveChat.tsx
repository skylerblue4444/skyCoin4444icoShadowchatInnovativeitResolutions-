...
export default function ShadowLiveChat() {
  const items = [
    ...
    },
    {
      icon: "👥",
      title: "Group Chats",
      desc: "Up to 1,000 members",
      badge: "Big",
    },
    {
      icon: "✦",
      title: "SKY4444 Tips",
      desc: "Send tips in chat",
      badge: "Fun",
    },
    {
      icon: "📎",
      title: "File Share",
      desc: "Images · Docs · NFTs",
      badge: "Easy",
    },
    {
      icon: "🤖",
      title: "AI Moderation",
      desc: "Auto-remove bad content",
      badge: "Safe",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Real-time messaging · Crypto tips · SKY4444 tipping
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Chat with the global crypto community. Tip with SKY4444.
          </p>
