  ...
  const items = [
    {
      icon: "🗺️",
      title: "Heatmap",
      desc: "Order book heatmap",
      badge: "Visual",
    },
    {
      icon: "📊",
      title: "Support",
      desc: "Key support levels",
      badge: "Buy Zone",
    },
    {
      icon: "📈",
      title: "Resistance",
      desc: "Key resistance levels",
      badge: "Sell Zone",
    },
    {
      icon: "💥",
      title: "Liquidations",
      desc: "Liquidation cluster map",
      badge: "Risk",
    },
    {
      icon: "🔍",
      title: "Zoom",
      desc: "Zoom into any price range",
      badge: "Precise",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 liquidity map",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Order book heatmap · Support resistance · Liquidation clusters
        </p>
      </div>
