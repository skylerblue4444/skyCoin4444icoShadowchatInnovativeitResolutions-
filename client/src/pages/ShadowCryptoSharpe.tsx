...
export default function ShadowCryptoSharpe() {
  const items = [
    ...
    },
    {
      icon: "🏆",
      title: "Best Ratio",
      desc: "Highest risk-adjusted returns",
      badge: "Optimal",
    },
    {
      icon: "📈",
      title: "Compare",
      desc: "Compare any two coins",
      badge: "Relative",
    },
    {
      icon: "💼",
      title: "Portfolio",
      desc: "Portfolio Sharpe ratio",
      badge: "Overall",
    },
    {
      icon: "📅",
      title: "Timeframes",
      desc: "30/90/365-day analysis",
      badge: "Flexible",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 Sharpe analysis",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Risk-adjusted returns · Compare coins · Portfolio optimization
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Find the best risk-adjusted returns.
          </p>
