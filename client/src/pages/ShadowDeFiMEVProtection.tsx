  ...
  const items = [
    {
      icon: "🥪",
      title: "Anti-Sandwich",
      desc: "Block sandwich attacks",
      badge: "Protected",
    },
    {
      icon: "🔐",
      title: "Private Mempool",
      desc: "Transactions stay private",
      badge: "Hidden",
    },
    {
      icon: "⚡",
      title: "Fast",
      desc: "Same speed as public mempool",
      badge: "No Tradeoff",
    },
    {
      icon: "💰",
      title: "Save",
      desc: "Save up to 5% on large trades",
      badge: "Valuable",
    },
    {
      icon: "📊",
      title: "MEV Stats",
      desc: "See MEV activity",
      badge: "Aware",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 trades protected",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Protect your trades from sandwich attacks · Private mempool
        </p>
      </div>
