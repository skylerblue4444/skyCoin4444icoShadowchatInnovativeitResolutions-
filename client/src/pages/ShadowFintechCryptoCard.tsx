  ...
  const items = [
    {
      icon: "💳",
      title: "Visa/MC",
      desc: "Works anywhere Visa is accepted",
      badge: "Universal",
    },
    {
      icon: "⚡",
      title: "Instant Convert",
      desc: "Crypto converts at point of sale",
      badge: "Seamless",
    },
    {
      icon: "💰",
      title: "Cashback",
      desc: "Up to 8% cashback in SKY4444",
      badge: "Reward",
    },
    {
      icon: "🌍",
      title: "Global",
      desc: "Use in 200+ countries",
      badge: "Everywhere",
    },
    {
      icon: "📱",
      title: "Virtual Card",
      desc: "Instant virtual card",
      badge: "Immediate",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "8% cashback in SKY4444",
      badge: "Best",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Spend crypto anywhere · Visa Mastercard · Instant convert
        </p>
      </div>
