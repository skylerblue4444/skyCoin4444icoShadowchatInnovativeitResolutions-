  ...
  const items = [
    {
      icon: "👨‍👩‍👧",
      title: "Inheritance",
      desc: "Crypto inheritance planning",
      badge: "Legacy",
    },
    {
      icon: "⏰",
    ...
    },
    {
      icon: "🔑",
      title: "Multi-Sig",
      desc: "Multi-sig inheritance wallet",
      badge: "Secure",
    },
    {
      icon: "⚖️",
      title: "Legal",
      desc: "Legal wrapper for crypto estate",
      badge: "Official",
    },
    {
      icon: "📋",
      title: "Instructions",
      desc: "Encrypted instructions for heirs",
      badge: "Prepared",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Inheritance · Dead man switch · Multi-sig · Legal wrapper
        </p>
      </div>
