  ...
  const items = [
    {
      icon: "📞",
      title: "Call Options",
      desc: "Right to buy at strike",
      badge: "Bullish",
    },
    {
      icon: "📤",
      title: "Put Options",
      desc: "Right to sell at strike",
      badge: "Bearish",
    },
    {
      icon: "📊",
      title: "Spreads",
      desc: "Defined risk strategies",
      badge: "Controlled",
    },
    {
      icon: "💰",
      title: "Premium",
      desc: "Earn by selling options",
      badge: "Income",
    },
    {
      icon: "🎯",
      title: "Expiry",
      desc: "Weekly monthly quarterly",
      badge: "Flexible",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Options on SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          On-chain options trading · Calls puts spreads · SKY4444
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Options trading on-chain for the first time.
          </p>
