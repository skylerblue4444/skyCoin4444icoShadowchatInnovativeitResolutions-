      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Deep token analytics — on-chain metrics, holder distribution, whale
            tracking, and sentiment
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            ...
            <p className="text-xs text-muted-foreground">On-Chain Metrics</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">84,247</p>
            <p className="text-xs text-muted-foreground">Whale Wallets</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">2.4B</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/30 to-violet-900/30 border border-indigo-500/20 p-4">
        <div className="flex items-center justify-between mb-3">
          <div>
            <p className="font-black text-sm">
              Token Analytics — Premium Access
            </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() =>
              toast.success("Token Analytics activated! Welcome aboard.")
            }
          >
