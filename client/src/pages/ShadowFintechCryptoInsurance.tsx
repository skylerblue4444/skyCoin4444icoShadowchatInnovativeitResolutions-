  ...
  const items = [
    {
      icon: "🛡️",
      title: "Hack Coverage",
      desc: "Covered if exchange is hacked",
      badge: "Protected",
    },
    {
      icon: "🔐",
      title: "Wallet Coverage",
      desc: "Lost key recovery insurance",
      badge: "Safe",
    },
    {
      icon: "📊",
      title: "Smart Contract",
      desc: "DeFi protocol failure coverage",
      badge: "DeFi",
    },
    {
      icon: "💰",
      title: "Low Premium",
      desc: "0.5% annual premium",
      badge: "Affordable",
    },
    {
      icon: "⚡",
      title: "Instant Claim",
      desc: "Claims paid in 24 hours",
      badge: "Fast",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Insure your crypto holdings · Hack coverage · Exchange risk
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Sleep soundly knowing your crypto is insured.
          </p>
