  ...
  const items = [
    {
      icon: "📚",
      title: "10 Lessons",
      desc: "Complete beginner course",
      badge: "Structured",
    },
    {
      icon: "🎥",
      title: "Video",
      desc: "Video lessons included",
      badge: "Visual",
    },
    {
      icon: "✅",
    ...
    },
    {
      icon: "🏆",
      title: "Certificate",
      desc: "Earn completion certificate",
      badge: "Credible",
    },
    {
      icon: "💰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Learn crypto from zero · 10 lessons · Earn SKY4444
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Go from zero to crypto in 10 lessons.
          </p>
