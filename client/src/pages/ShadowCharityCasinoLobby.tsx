    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Live casino games. 10% of house edge goes to verified charities. Play
          slots, blackjack, poker, and roulette with SKY4444.
        </p>
      </div>
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-5 space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Live casino games. 10% of house edge goes to verified charities.
            Play slots, blackjack, poker, and roulette with SKY4444.
          </p>
