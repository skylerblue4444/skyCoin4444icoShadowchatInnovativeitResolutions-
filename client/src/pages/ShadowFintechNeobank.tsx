  ...
  const items = [
    {
      icon: "💳",
      title: "Debit Card",
      desc: "Spend crypto anywhere",
      badge: "Convenient",
    },
    {
      icon: "🏦",
      title: "Account",
      desc: "USD and crypto account",
      badge: "Complete",
    },
    {
      icon: "💰",
      title: "Savings",
      desc: "4.4% APY on USD balance",
      badge: "Earn",
    },
    {
      icon: "🏠",
      title: "Loans",
      desc: "Borrow against crypto",
      badge: "Flexible",
    },
    {
      icon: "📱",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Bank account for crypto people · Debit card · Savings · Loans
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The bank built for crypto people.
          </p>
