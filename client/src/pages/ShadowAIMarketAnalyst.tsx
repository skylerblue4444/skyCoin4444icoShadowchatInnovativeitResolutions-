  ...
  const items = [
    {
      icon: "🤖",
      title: "Daily Report",
      desc: "AI market summary every morning",
      badge: "Insight",
    },
    {
      icon: "📊",
      title: "Chart Analysis",
      desc: "AI reads your charts",
      badge: "Smart",
    },
    {
      icon: "💡",
      title: "Trade Ideas",
      desc: "3 trade ideas per day",
      badge: "Actionable",
    },
    {
      icon: "📰",
      title: "News Impact",
      desc: "AI scores news sentiment",
      badge: "Context",
    },
    {
      icon: "🎯",
      title: "Price Targets",
      desc: "AI-generated price targets",
      badge: "Precise",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 analysis included",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          GPT-powered market analysis · Daily reports · Trade ideas
        </p>
      </div>
