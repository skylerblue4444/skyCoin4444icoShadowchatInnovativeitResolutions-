  ...
  const items = [
    {
      icon: "📊",
      title: "Diversified",
      desc: "Top 10 20 100 crypto index",
      badge: "Spread",
    },
    {
      icon: "🔄",
      title: "Auto-Rebalance",
      desc: "Monthly automatic rebalancing",
      badge: "Disciplined",
    },
    {
      icon: "💰",
      title: "Low Fees",
      desc: "0.5% annual management fee",
      badge: "Affordable",
    },
    {
      icon: "📈",
      title: "Performance",
      desc: "Track index performance",
      badge: "Measure",
    },
    {
      icon: "🌍",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 included in index",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Diversified crypto index · Auto-rebalance · Low fees · SKY4444
        </p>
      </div>
