  ...
  const items = [
    {
      icon: "💰",
      title: "Lend",
      desc: "Earn yield by lending",
      badge: "Income",
    },
    {
      icon: "🏦",
      title: "Borrow",
      desc: "Borrow against collateral",
      badge: "Liquidity",
    },
    {
      icon: "🌉",
      title: "Cross-Chain",
      desc: "Lend and borrow cross-chain",
      badge: "Universal",
    },
    {
      icon: "📊",
      title: "Best Rates",
      desc: "AI finds best rates",
      badge: "Optimal",
    },
    {
      icon: "🛡️",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Lend and borrow crypto · Best rates · Cross-chain · SKY4444
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The best rates in DeFi lending.
          </p>
