  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🎁 Airdrop 2.0</h1>
          <p className="text-sm text-muted-foreground">
            Participate in and manage token airdrops — eligibility checking,
            snapshot, and automated distribution
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Free Tokens</Badge>
      </div>
