  ...
  const items = [
    {
      icon: "🟢",
      title: "Green",
      desc: "Gainers highlighted green",
      badge: "Visual",
    },
    {
      icon: "🔴",
      title: "Red",
      desc: "Losers highlighted red",
      badge: "Visual",
    },
    {
      icon: "📊",
      title: "Sectors",
      desc: "DeFi NFT L1 L2 sectors",
      badge: "Categorized",
    },
    {
      icon: "📏",
      title: "Market Cap",
      desc: "Size by market cap",
      badge: "Proportional",
    },
    {
      icon: "⏰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Visual market overview · Sector rotation · Size by market cap
        </p>
      </div>
