...
export default function ShadowCryptoSDKV2() {
  ...
  const items = [
    { icon: "🟨", title: "JavaScript", desc: "Full JS/TS SDK", badge: "Web" },
    {
      icon: "🐍",
      title: "Python",
    ...
    },
    {
      icon: "🐹",
      title: "Go",
      desc: "Go SDK for high performance",
      badge: "Speed",
    },
    {
      icon: "🦀",
      title: "Rust",
      desc: "Rust SDK for systems",
      badge: "Systems",
    },
    {
      icon: "📚",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          JavaScript Python Go Rust SDKs · Type-safe · Auto-generated
        </p>
      </div>
