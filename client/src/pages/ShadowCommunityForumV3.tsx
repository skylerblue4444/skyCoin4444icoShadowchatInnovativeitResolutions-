  ...
  const items = [
    {
      icon: "💬",
      title: "Discuss",
      desc: "Discuss any crypto topic",
      badge: "Open",
    },
    {
      icon: "🛡️",
      title: "Moderated",
      desc: "AI and human moderation",
      badge: "Safe",
    },
    {
      icon: "💰",
    ...
    },
    {
      icon: "✅",
      title: "Verified",
      desc: "Verified expert badges",
      badge: "Trusted",
    },
    {
      icon: "🔍",
      title: "Search",
      desc: "Full-text forum search",
      badge: "Find",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Earn SKY4444 in forum",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Discuss crypto IT SKY4444 · Moderated · Rewards · Verified
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The best crypto community forum.
          </p>
