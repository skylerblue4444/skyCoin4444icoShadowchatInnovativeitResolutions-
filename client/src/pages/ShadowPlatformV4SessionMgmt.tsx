  ...
  const items = [
    {
      ...
      desc: "See all logged-in devices",
      badge: "Aware",
    },
    {
      icon: "🚫",
      title: "Remote Logout",
      desc: "Logout any device remotely",
      badge: "Control",
    },
    {
      icon: "✅",
      title: "Device Trust",
      desc: "Mark devices as trusted",
      badge: "Convenient",
    },
    {
      icon: "📊",
      title: "Activity Log",
      desc: "Full session activity log",
      badge: "Audit",
    },
    {
      icon: "🔔",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          See all active sessions · Remote logout · Device trust
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Complete control over your account security.
          </p>
