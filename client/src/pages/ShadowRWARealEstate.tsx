  ...
  const items = [
    {
      icon: "🏠",
      title: "Fractional",
      desc: "Own a piece of any property",
      badge: "Accessible",
    },
    {
      icon: "💰",
      title: "Rental Income",
      desc: "Earn rental income daily",
      badge: "Passive",
    },
    {
      icon: "💧",
      title: "Liquid",
      desc: "Sell your share anytime",
      badge: "Flexible",
    },
    {
      icon: "🌍",
      title: "Global",
      desc: "Properties worldwide",
      badge: "Wide",
    },
    {
      icon: "📊",
      title: "Transparent",
      desc: "On-chain ownership records",
      badge: "Open",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Buy real estate with SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Fractional real estate · Rental income · Liquidity
        </p>
      </div>
