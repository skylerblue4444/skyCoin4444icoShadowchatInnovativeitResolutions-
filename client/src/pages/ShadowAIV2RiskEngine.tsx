  ...
  const items = [
    {
      icon: "📊",
      title: "Risk Score",
      desc: "1-100 portfolio risk rating",
      badge: "Clear",
    },
    {
      icon: "💥",
      title: "VaR",
      desc: "Value at Risk calculation",
      badge: "Quantified",
    },
    {
      icon: "🧪",
      title: "Stress Test",
      desc: "Simulate market crashes",
      badge: "Prepared",
    },
    {
      icon: "🔔",
      title: "Risk Alerts",
      desc: "Alert when risk spikes",
      badge: "Aware",
    },
    {
      icon: "📈",
      title: "Correlation",
      desc: "Asset correlation analysis",
      badge: "Diversified",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 risk metrics",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Portfolio risk scoring · VaR · Stress testing · Alerts
        </p>
      </div>
