  ...
  const items = [
    {
      icon: "🐋",
      title: "Whale Wallets",
      desc: "Track top 1000 wallets",
      badge: "Signal",
    },
    {
      icon: "🏦",
      title: "VC Wallets",
      desc: "Track venture capital moves",
      badge: "Informed",
    },
    {
      icon: "👨‍💻",
      title: "Team Wallets",
      desc: "Protocol team wallet activity",
      badge: "Insider",
    },
    {
      icon: "🔔",
      title: "Alerts",
      desc: "Alert on large movements",
      badge: "First",
    },
    {
      icon: "📊",
      title: "History",
      desc: "Full wallet history",
      badge: "Complete",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 insider tracking",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Track whale wallets · VC moves · Protocol team wallets
        </p>
      </div>
