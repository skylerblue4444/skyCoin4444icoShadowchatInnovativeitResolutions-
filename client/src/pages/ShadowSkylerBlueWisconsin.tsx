    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Managed IT services in Wisconsin with Milwaukee, Madison, and
            statewide coverage
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            ...
            <p className="text-xs text-muted-foreground">Wisconsin Clients</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">
          Wisconsin IT Services — Get Started Today
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("Wisconsin IT Services activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() =>
              toast.info("Contacting Wisconsin IT Services team...")
            }
          >
