...
export default function ShadowITServiceMicrosoftTeams() {
  ...
  const items = [
    ...
    },
    {
      icon: "📞",
      title: "Calling",
      desc: "Teams calling plans",
      badge: "Unified",
    },
    {
      icon: "🔐",
      title: "Security",
      desc: "Teams security hardening",
      badge: "Safe",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Teams deployment · Training · Integration · Arkansas IT
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Get your team on Teams the right way.
          </p>
