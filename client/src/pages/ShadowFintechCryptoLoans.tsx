  ...
  const items = [
    {
      icon: "💵",
      title: "Get USD",
      desc: "Borrow dollars instantly",
      badge: "Liquid",
    },
    {
      icon: "🔐",
      title: "Keep Crypto",
      desc: "Don't sell your crypto",
      badge: "Hold",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "💰",
      title: "Low Rate",
      desc: "4.4% annual interest rate",
      badge: "Cheap",
    },
    {
      icon: "⚡",
      title: "Instant",
      desc: "Funds in under 1 hour",
      badge: "Fast",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Borrow USD against BTC ETH SKY4444 · No credit check
        </p>
      </div>
