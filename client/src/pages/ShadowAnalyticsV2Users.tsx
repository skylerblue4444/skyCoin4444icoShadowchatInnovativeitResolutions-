  ...
  const items = [
    {
      icon: "👥",
      title: "DAU/MAU",
      desc: "Daily and monthly active users",
      badge: "Core",
    },
    {
      icon: "🔄",
      title: "Retention",
      desc: "7-day 30-day retention",
      badge: "Sticky",
    },
    {
      icon: "📊",
      title: "Cohorts",
      desc: "User cohort analysis",
      badge: "Deep",
    },
    {
      icon: "🌍",
    ...
    },
    {
      icon: "📱",
      title: "Device",
      desc: "Mobile vs desktop split",
      badge: "Platform",
    },
    {
      icon: "📈",
      title: "Growth",
      desc: "User growth rate",
      badge: "Trending",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Active users · Retention · Cohorts · Geographic breakdown
        </p>
      </div>
