...
export default function ShadowCompanyPress() {
  ...
  const items = [
    ...
    },
    {
      ...
      desc: "News coverage of ShadowChat",
      badge: "Recognition",
    },
    {
      icon: "📦",
      title: "Press Kit",
      desc: "Logos brand assets guidelines",
      badge: "Media",
    },
    {
      icon: "🎤",
      title: "Interviews",
      desc: "Founder interview requests",
      badge: "Engage",
    },
    {
      icon: "📧",
      title: "Press Contact",
      desc: "press@shadowchat.io",
      badge: "Contact",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 in the news",
      badge: "Coverage",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Press releases · Media coverage · Press kit · Interviews
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The ShadowChat story in the press.
          </p>
