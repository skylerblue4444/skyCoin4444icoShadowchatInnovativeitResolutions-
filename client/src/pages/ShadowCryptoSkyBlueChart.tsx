  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">📊 Advanced Charts</h1>
          <p className="text-sm text-muted-foreground">
            Professional-grade crypto charts with 100+ indicators, drawing
            tools, and multi-timeframe analysis
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Pro Charts</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-violet-400"}>100+</p>
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            ...
            <p className="text-xs text-muted-foreground">Drawing Tools</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
