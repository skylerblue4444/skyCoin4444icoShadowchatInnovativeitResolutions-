  ...
  const items = [
    {
      icon: "🎨",
      title: "Create",
      desc: "Create NFTs in minutes",
      badge: "Easy",
    },
    {
      icon: "🛒",
      title: "Buy",
      desc: "Buy NFTs at best prices",
      badge: "Smart",
    },
    {
      icon: "💰",
      title: "Sell",
      desc: "Sell with lowest fees",
      badge: "Profitable",
    },
    {
      icon: "🌍",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Buy sell create NFTs · All chains · Lowest fees · SKY4444
        </p>
      </div>
