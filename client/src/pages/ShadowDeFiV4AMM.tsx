  ...
  const items = [
    {
      icon: "💧",
      title: "Concentrated",
      desc: "Provide liquidity in range",
      badge: "Efficient",
    },
    {
      icon: "💰",
      title: "Custom Fees",
      desc: "0.01% to 1% fee tiers",
      badge: "Flexible",
    },
    {
      icon: "🛡️",
      title: "MEV Guard",
      desc: "Protected from sandwich attacks",
      badge: "Safe",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Pool performance dashboard",
      badge: "Visible",
    },
    {
      icon: "🔄",
      title: "Auto-Range",
      desc: "AI manages your range",
      badge: "Smart",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 liquidity pools",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Concentrated liquidity · Custom fee tiers · MEV protection
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The most capital-efficient AMM ever built.
          </p>
