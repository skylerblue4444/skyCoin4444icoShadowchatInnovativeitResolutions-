  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🌊 DeFi 2.0 Hub</h1>
          <p className="text-sm text-muted-foreground">
            Next-generation DeFi with protocol-owned liquidity, rebasing tokens,
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-purple-400"}>$847M</p>
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            ...
            <p className="text-xs text-muted-foreground">Sustainable APY</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">$247M</p>
            <p className="text-xs text-muted-foreground">POL</p>
          </CardContent>
        </Card>
      </div>
