  ...
  const items = [
    {
      icon: "⛏️",
      title: "Mining Basics",
      desc: "How mining works",
      badge: "Foundation",
    },
    {
      icon: "💻",
      title: "CPU Mining",
      desc: "Mine with your computer",
      badge: "Accessible",
    },
    {
      icon: "🖥️",
      title: "GPU Mining",
      desc: "GPU mining setup guide",
      badge: "Power",
    },
    {
      icon: "📊",
      title: "Profitability",
      desc: "Calculate mining profits",
      badge: "Smart",
    },
    {
      icon: "🔌",
      title: "Pool Mining",
      desc: "Join a mining pool",
      badge: "Together",
    },
    {
      icon: "💰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Mine BTC DOGE SKY4444 XMR · Hardware software · Profitability
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Mine crypto like a professional.
          </p>
