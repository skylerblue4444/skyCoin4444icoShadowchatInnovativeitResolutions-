  ...
  const items = [
    {
      icon: "📊",
      title: "Calculate",
      desc: "Calculate crypto taxes automatically",
      badge: "Easy",
    },
    {
      icon: "📄",
      title: "Reports",
      desc: "Generate IRS-ready tax reports",
      badge: "Compliant",
    },
    {
      icon: "🗂️",
      title: "Form 8949",
      desc: "Auto-generate Form 8949",
      badge: "Specific",
    },
    {
      icon: "💼",
      title: "CPA Connect",
      desc: "Connect with crypto CPAs",
      badge: "Expert",
    },
    {
      icon: "🌍",
      title: "Multi-Country",
      desc: "US UK EU Canada Australia",
      badge: "Global",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 tax reporting",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Calculate taxes · Generate reports · IRS forms · CPA connect
        </p>
      </div>
