  ...
  const items = [
    {
      icon: "🐛",
      title: "Bug Bounty",
      desc: "Up to $100K for critical bugs",
      badge: "Incentive",
    },
    {
      icon: "🔍",
      title: "Pen Testing",
      desc: "Regular penetration testing",
      badge: "Proactive",
    },
    {
      icon: "📋",
      title: "Audits",
      desc: "Smart contract audits",
      badge: "Verified",
    },
    {
      icon: "🔐",
      title: "Encryption",
      desc: "AES-256 encryption everywhere",
      badge: "Strong",
    },
    {
      icon: "🌍",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Bug bounty · Penetration testing · Audits · Responsible disclosure
        </p>
      </div>
