  ...
  const items = [
    {
      icon: "🏦",
      title: "Isolated",
      desc: "Isolated lending markets",
      badge: "Safe",
    },
    {
      icon: "🔀",
      title: "Cross-Collateral",
      desc: "Use multiple assets as collateral",
      badge: "Flexible",
    },
    {
      icon: "🤖",
    ...
    },
    {
      icon: "⚡",
      title: "Flash Loans",
      desc: "Uncollateralized flash loans",
      badge: "Advanced",
    },
    {
      icon: "💰",
      title: "Earn",
      desc: "Earn yield on deposits",
      badge: "Income",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Lend and borrow SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Isolated markets · Cross-collateral · AI risk · Flash loans
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The most advanced lending protocol.
          </p>
