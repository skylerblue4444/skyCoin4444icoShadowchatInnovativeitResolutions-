  ...
  const items = [
    {
      ...
      desc: "In-depth coin analysis",
      badge: "Deep",
    },
    {
      icon: "🤖",
      title: "AI Analysis",
      desc: "AI-generated research",
      badge: "Fast",
    },
    {
      icon: "👨‍💻",
      title: "Expert Opinions",
      desc: "Top analyst commentary",
      badge: "Credible",
    },
    {
      icon: "📊",
      title: "Data",
      desc: "On-chain and market data",
      badge: "Evidence",
    },
    {
      icon: "🏆",
      title: "Top Picks",
      desc: "Analyst top picks",
      badge: "Actionable",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Deep research reports · AI analysis · Expert opinions
        </p>
      </div>
