  ...
  const items = [
    {
      icon: "⛏️",
      title: "Mining",
      desc: "Miner Pro · SKY4444 · TRUMP",
      badge: "Earn",
    },
    {
      icon: "💱",
      title: "Trading",
      desc: "Scream Room · Charts · Bots",
      badge: "Trade",
    },
    {
      icon: "🛒",
      title: "Shopping",
      desc: "Global Market · Shop · NFTs",
      badge: "Buy",
    },
    {
      icon: "💕",
      title: "Social",
      desc: "CryptoDate · Feed · Chat",
      badge: "Connect",
    },
    {
      icon: "💻",
      title: "IT Services",
      desc: "Help Desk · Managed · Security",
      badge: "Support",
    },
    {
      icon: "📚",
      title: "Learn",
      desc: "Academy · School · Certs",
      badge: "Grow",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Every page on ShadowChat · 1,655 pages · Navigate easily
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Explore all 1,655 pages of ShadowChat.
          </p>
