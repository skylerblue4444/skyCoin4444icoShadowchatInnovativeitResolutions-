  ...
  const items = [
    {
      icon: "📞",
      title: "Call Options",
      desc: "Right to buy at strike price",
      badge: "Bullish",
    },
    {
      icon: "📉",
      title: "Put Options",
      desc: "Right to sell at strike price",
      badge: "Bearish",
    },
    {
      icon: "🛡️",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 options available",
      badge: "Unique",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Buy calls/puts on BTC ETH TRUMP SKY4444 · Hedge or speculate
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Trade crypto options like a pro.
          </p>
