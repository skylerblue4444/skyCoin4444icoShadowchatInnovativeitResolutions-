...
export default function ShadowDarkMode() {
  const items = [
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 gold accent theme",
      badge: "Exclusive",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Customize your ShadowChat theme · Dark light system
        </p>
      </div>
