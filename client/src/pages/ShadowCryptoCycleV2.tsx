  ...
  const items = [
    {
      icon: "📅",
      title: "4-Year Cycle",
      desc: "Bitcoin 4-year cycle",
      badge: "Framework",
    },
    {
      icon: "⛏️",
      title: "Halving",
      desc: "Halving impact analysis",
      badge: "Key Event",
    },
    {
      icon: "💰",
      title: "Accumulation",
      desc: "Accumulation phase signals",
      badge: "Buy",
    },
    {
      icon: "📤",
      title: "Distribution",
      desc: "Distribution phase signals",
      badge: "Sell",
    },
    {
      icon: "📊",
      title: "Where Now",
      desc: "Where are we in the cycle",
      badge: "Current",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 cycle analysis",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          4-year cycle analysis · Halving · Accumulation · Distribution
        </p>
      </div>
