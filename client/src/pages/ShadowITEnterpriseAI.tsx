  ...
  const items = [
    {
      icon: "🤖",
      title: "ChatGPT",
      desc: "OpenAI integration for business",
      badge: "Smart",
    },
    {
      icon: "💼",
      title: "Copilot",
      desc: "Microsoft 365 Copilot setup",
      badge: "Productive",
    },
    {
      icon: "🧠",
      title: "Gemini",
      desc: "Google AI for workspace",
      badge: "Powerful",
    },
    {
      icon: "📊",
      title: "Custom AI",
      desc: "Custom AI for your data",
      badge: "Tailored",
    },
    {
      icon: "🔐",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Add AI to your business · ChatGPT Copilot Gemini · Arkansas
        </p>
      </div>
