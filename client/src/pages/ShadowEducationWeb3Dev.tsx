  ...
  const items = [
    {
      icon: "📚",
      title: "12 Weeks",
      desc: "Intensive 12-week program",
      badge: "Structured",
    },
    {
      icon: "⚙️",
      title: "Solidity",
      desc: "Ethereum smart contracts",
      badge: "Skill",
    },
    {
      icon: "🦀",
      title: "Rust",
      desc: "Solana program development",
      badge: "Skill",
    },
    {
      icon: "💼",
      title: "Job Placement",
      desc: "Help finding Web3 jobs",
      badge: "Career",
    },
    {
      icon: "🏆",
      title: "Certificate",
      desc: "Web3 developer certificate",
      badge: "Credible",
    },
    {
      icon: "💰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          12-week bootcamp · Solidity Rust · Job placement · SKY4444
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Go from zero to Web3 developer in 12 weeks.
          </p>
