  ...
  const items = [
    {
      icon: "🔄",
      title: "Auto-Copy",
      desc: "Automatically copy top traders",
      badge: "Hands-free",
    },
    {
      icon: "🏆",
      title: "Top Traders",
      desc: "Verified top performer list",
      badge: "Quality",
    },
    {
      icon: "🛡️",
      title: "Risk Controls",
      desc: "Set max loss limits",
      badge: "Safe",
    },
    {
      icon: "📊",
      title: "Performance",
      desc: "Track copy trading returns",
      badge: "Measure",
    },
    {
      icon: "💰",
      title: "Profit Share",
      desc: "Traders earn from your profits",
      badge: "Aligned",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Copy the best traders automatically · Risk controls · SKY4444
        </p>
      </div>
