  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🏛️ Government IT</h1>
          <p className="text-sm text-muted-foreground">
            Government and public sector IT solutions for Arkansas — FedRAMP,
            FISMA, and NIST compliance
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">FedRAMP</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-blue-400"}>12</p>
            <p className="text-xs text-muted-foreground">Government Clients</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">SECRET</p>
