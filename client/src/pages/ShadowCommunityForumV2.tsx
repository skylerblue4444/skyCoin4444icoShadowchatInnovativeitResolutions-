...
export default function ShadowCommunityForumV2() {
  ...
  const items = [
    ...
    },
    {
      icon: "📊",
      title: "Analysis",
      desc: "Share your market analysis",
      badge: "Insightful",
    },
    {
      icon: "🏆",
      title: "Reputation",
      desc: "Build your forum reputation",
      badge: "Credible",
    },
    {
      icon: "💰",
      title: "Earn",
      desc: "Earn SKY4444 for best answers",
      badge: "Incentive",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Upgraded forum · Categories · Reputation · SKY4444 rewards
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The smartest crypto community online.
          </p>
