  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Become a SKY4444 brand ambassador and earn rewards for community
            growth
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">Monthly</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-yellow-900/40 to-orange-900/40 border border-yellow-500/30 p-4">
        <p className="font-black text-sm mb-1">
          SKY4444 Ambassador — Explore Now
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("SKY4444 Ambassador activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Opening SKY4444 Ambassador docs...")}
          >
