...
export default function ShadowCryptoZKProofs() {
  ...
  const items = [
    ...
    },
    {
      icon: "📈",
      title: "Scaling",
      desc: "ZK rollups for scaling",
      badge: "Scale",
    },
    {
      icon: "🆔",
      title: "Identity",
      desc: "ZK identity proofs",
      badge: "Sovereign",
    },
    {
      icon: "⚖️",
      title: "Compliance",
      desc: "Compliant privacy",
      badge: "Legal",
    },
    {
      icon: "🔬",
      title: "Research",
      desc: "Latest ZK research",
      badge: "Cutting-edge",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "ZK proofs for SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          ZK technology · Privacy · Scaling · Identity · Compliance
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The cryptography that changes everything.
          </p>
