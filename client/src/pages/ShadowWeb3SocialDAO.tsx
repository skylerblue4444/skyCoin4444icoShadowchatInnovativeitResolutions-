  ...
  const items = [
    {
      icon: "🏛️",
      title: "Your DAO",
      desc: "Launch your creator DAO",
      badge: "Ownership",
    },
    {
      icon: "🪙",
      title: "Fan Tokens",
      desc: "Issue tokens to your fans",
      badge: "Community",
    },
    {
      icon: "🗳️",
      title: "Governance",
      desc: "Fans vote on your content",
      badge: "Democratic",
    },
    {
      icon: "💰",
      title: "Revenue Share",
      desc: "Share revenue with token holders",
      badge: "Fair",
    },
    {
      icon: "🎁",
      title: "Exclusive",
      desc: "Token-gated exclusive content",
      badge: "Premium",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "DAO treasury in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Launch your own creator DAO · Fan tokens · Governance
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Turn your audience into co-owners.
          </p>
