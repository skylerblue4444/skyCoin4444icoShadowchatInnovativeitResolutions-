  ...
  const items = [
    {
      icon: "📞",
      title: "Cloud PBX",
      desc: "Cloud-based phone system",
      badge: "Modern",
    },
    {
      icon: "♾️",
      title: "Unlimited Calls",
      desc: "Unlimited US calling",
      badge: "Value",
    },
    {
      icon: "📱",
      title: "Mobile App",
      desc: "Take calls on your phone",
      badge: "Flexible",
    },
    {
      icon: "🔌",
      title: "Integrations",
      desc: "CRM and helpdesk integration",
      badge: "Connected",
    },
    {
      icon: "💰",
      title: "Save 60%",
      desc: "Save vs traditional phone",
      badge: "Affordable",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Business phone systems · Cloud PBX · Unlimited calls · Arkansas
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Modern business phones for less.
          </p>
