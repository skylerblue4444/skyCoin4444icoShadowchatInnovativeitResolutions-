  ...
  const items = [
    {
      icon: "❓",
      title: "What is MSP?",
      desc: "Managed service provider explained",
      badge: "Educate",
    },
    {
      icon: "💰",
      title: "How much?",
      desc: "Pricing and packages",
      badge: "Transparent",
    },
    {
      icon: "⏰",
      title: "Response Time",
      desc: "Our SLA commitments",
      badge: "Committed",
    },
    {
      icon: "🌍",
      title: "Service Area",
      desc: "Arkansas and remote",
      badge: "Where",
    },
    {
      icon: "🔐",
      title: "Security",
      desc: "How we secure your business",
      badge: "Safe",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Common questions about Skyler Blue IT Resolutions
        </p>
      </div>
