  ...
  const items = [
    {
      ...
      desc: "CPU RAM disk network",
      badge: "Always",
    },
    {
      icon: "🌐",
      title: "Network Monitor",
      desc: "Bandwidth latency packet loss",
      badge: "Connected",
    },
    {
      icon: "☁️",
      title: "Cloud Monitor",
      desc: "AWS Azure GCP monitoring",
      badge: "Multi-cloud",
    },
    {
      icon: "🔔",
      title: "Smart Alerts",
      desc: "Alert on anomalies only",
      badge: "Intelligent",
    },
    {
      icon: "🤖",
      title: "Auto-Fix",
      desc: "Auto-remediate common issues",
      badge: "Proactive",
    },
    {
      icon: "📞",
      title: "Escalate",
      desc: "479-406-7123 for critical",
      badge: "Human",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          24/7 infrastructure monitoring · Alerts · Auto-remediation
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Never be surprised by downtime again.
          </p>
