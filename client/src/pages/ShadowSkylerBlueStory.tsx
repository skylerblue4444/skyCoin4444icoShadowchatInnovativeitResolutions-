  ...
  const items = [
    {
      icon: "🏠",
      title: "Built at Home",
      desc: "Every line coded at home",
      badge: "Authentic",
    },
    {
      icon: "🗺️",
      title: "Arkansas",
      desc: "Fayetteville AR to the world",
      badge: "Origin",
    },
    {
      icon: "🤖",
      title: "AI-Assisted",
      desc: "AI helped but Skyler directed",
      badge: "Smart",
    },
    {
      icon: "💰",
      title: "$1M+ Value",
      desc: "Million dollar codebase",
      badge: "Valuable",
    },
    {
      icon: "🙏",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Built at home in Arkansas · One page at a time · God willing
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            One developer. One dream. Built from scratch.
          </p>
