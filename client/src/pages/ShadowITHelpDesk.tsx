  ...
  const items = [
    {
      ...
      desc: "Fix any issue remotely",
      badge: "Fast",
    },
    {
      icon: "🏠",
      title: "On-Site Visit",
      desc: "Fayetteville · Rogers · Bentonville",
      badge: "Local",
    },
    {
      icon: "📞",
    ...
    },
    {
      ...
      desc: "PC · Mac · Laptop · Server",
      badge: "Expert",
    },
    {
      icon: "🌐",
      title: "Network Setup",
      desc: "WiFi · Ethernet · VPN",
      badge: "Pro",
    },
    {
      icon: "🛡️",
      title: "Security Audit",
      desc: "Virus removal · Firewall",
      badge: "Safe",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          24/7 IT support · Remote · On-site · Arkansas · Nationwide
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Expert IT support from Skyler Blue. Call 479-406-7123 anytime.
          </p>
