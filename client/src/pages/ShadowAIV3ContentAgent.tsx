  ...
  const items = [
    {
      icon: "📝",
      title: "Auto-Post",
      desc: "AI generates and posts content",
      badge: "Automated",
    },
    {
      icon: "🐦",
      title: "Twitter",
      desc: "AI tweets for your account",
      badge: "Social",
    },
    {
      icon: "📧",
      title: "Newsletter",
      desc: "AI writes your newsletter",
      badge: "Written",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "🎯",
      title: "On-Brand",
      desc: "Matches your voice and style",
      badge: "Authentic",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Content about SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Auto-generate crypto content · Posts tweets newsletters
        </p>
      </div>
