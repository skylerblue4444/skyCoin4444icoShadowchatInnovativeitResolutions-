  ...
  const items = [
    {
      icon: "🏛️",
      title: "US Treasuries",
      desc: "Tokenized T-bills and bonds",
      badge: "Safe",
    },
    {
      icon: "💰",
      title: "4-5% Yield",
      desc: "Real yield from real bonds",
      badge: "Income",
    },
    {
      icon: "⚡",
      title: "Instant",
      desc: "Settle in seconds not days",
      badge: "Fast",
    },
    {
      icon: "🌍",
      title: "Global",
      desc: "Anyone can access US bonds",
      badge: "Universal",
    },
    {
      icon: "📊",
      title: "Transparent",
      desc: "On-chain proof of ownership",
      badge: "Open",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Buy bonds with SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          US Treasury bonds on-chain · Yield · Instant settlement
        </p>
      </div>
