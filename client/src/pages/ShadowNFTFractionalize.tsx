  ...
  const items = [
    {
      icon: "✂️",
      title: "Fractionalize",
      desc: "Split any NFT into tokens",
      badge: "Accessible",
    },
    {
      icon: "💰",
      title: "Own a Piece",
      desc: "Buy fractions of expensive NFTs",
      badge: "Affordable",
    },
    {
      icon: "💹",
      title: "Trade",
      desc: "Trade NFT fractions",
      badge: "Liquid",
    },
    {
      icon: "🗳️",
      title: "Governance",
      desc: "Vote on NFT decisions",
      badge: "Democratic",
    },
    {
      icon: "📊",
      title: "Valuation",
      desc: "Real-time NFT valuation",
      badge: "Priced",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Buy fractions with SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Fractionalize expensive NFTs · Own a piece · Trade fractions
        </p>
      </div>
