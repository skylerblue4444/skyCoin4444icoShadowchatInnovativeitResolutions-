...
export default function ShadowSkylerBlueServices() {
  ...
  const items = [
    ...
    },
    {
      icon: "⛏️",
      title: "Crypto Setup",
      desc: "Set up crypto mining",
      badge: "Unique",
    },
    {
      icon: "🌐",
      title: "Networking",
      desc: "WiFi cabling servers",
      badge: "Connected",
    },
    {
      icon: "☁️",
      title: "Cloud",
      desc: "Microsoft 365 AWS Azure",
      badge: "Modern",
    },
    {
      icon: "📞",
      title: "Quote",
      desc: "479-406-7123 for free quote",
      badge: "Free",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Full IT services · Crypto integration · Arkansas and remote
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The only IT company that accepts SKY4444.
          </p>
