  ...
  const items = [
    {
      icon: "🤝",
      title: "Tech Partners",
      desc: "Chainlink Pyth Uniswap",
      badge: "Integrated",
    },
    {
      icon: "🏦",
      title: "Exchange Partners",
      desc: "Binance Coinbase OKX",
      badge: "Listed",
    },
    {
      icon: "🛒",
      title: "Commerce",
      desc: "Shopify DHgate Alibaba",
      badge: "Commerce",
    },
    {
      icon: "📱",
      title: "App Partners",
      desc: "iOS Android integrations",
      badge: "Mobile",
    },
    {
      icon: "🌍",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "All partners accept SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Strategic partners · Integration · Co-marketing · Revenue share
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The most connected token in crypto.
          </p>
