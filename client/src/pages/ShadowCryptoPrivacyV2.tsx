  ...
  const items = [
    {
      icon: "🔐",
      title: "Private Txns",
      desc: "Send crypto privately",
      badge: "Private",
    },
    {
      icon: "🔵",
      title: "zkProofs",
      desc: "Zero-knowledge proof privacy",
      badge: "Cryptographic",
    },
    {
      icon: "🌀",
      title: "Mixer",
      desc: "Privacy-preserving mixer",
      badge: "Anonymous",
    },
    {
      icon: "🛡️",
      title: "Stealth Addr",
      desc: "Stealth address generation",
      badge: "Unlinkable",
    },
    {
      icon: "⚖️",
      title: "Compliant",
      desc: "Compliance-friendly privacy",
      badge: "Legal",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Private SKY4444 transactions",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Tornado Cash alternative · zkProofs · Private transactions
        </p>
      </div>
