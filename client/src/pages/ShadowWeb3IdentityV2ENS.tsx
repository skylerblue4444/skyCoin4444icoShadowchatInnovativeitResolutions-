  ...
  const items = [
    {
      icon: "🌐",
      title: ".eth Names",
      desc: "Register your .eth domain",
      badge: "Identity",
    },
    {
      icon: "🔗",
      title: "Subdomains",
      desc: "Create unlimited subdomains",
      badge: "Flexible",
    },
    {
      icon: "👤",
      title: "Profile",
      desc: "ENS profile with avatar",
      badge: "Visible",
    },
    { icon: "💰", title: "Resell", desc: "Trade ENS domains", badge: "Market" },
    {
      icon: "🔍",
      title: "Lookup",
      desc: "Resolve any ENS name",
      badge: "Utility",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Pay for ENS in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Buy manage ENS domains · .eth names · Subdomains · Profiles
        </p>
      </div>
