...
export default function ShadowWeb3SocialV2Bluesky() {
  ...
  const items = [
    ...
    },
    {
      icon: "🔵",
      title: "AT Protocol",
      desc: "Open decentralized protocol",
      badge: "Open",
    },
    {
      icon: "📰",
      title: "Custom Feeds",
      desc: "Algorithm you control",
      badge: "Yours",
    },
    {
      icon: "🛡️",
      title: "Moderation",
      desc: "Community-based moderation",
      badge: "Safe",
    },
    {
      icon: "🔗",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          AT Protocol · Decentralized · Custom feeds · Moderation
        </p>
      </div>
