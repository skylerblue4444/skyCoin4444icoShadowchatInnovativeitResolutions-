  ...
  const items = [
    {
      icon: "🔑",
      title: "Create Keys",
      desc: "Generate API keys instantly",
      badge: "Easy",
    },
    {
      icon: "🔐",
      title: "Scoped",
      desc: "Limit key permissions",
      badge: "Secure",
    },
    {
      icon: "🔄",
      title: "Rotate",
      desc: "Rotate keys on schedule",
      badge: "Safe",
    },
    {
      icon: "📊",
      title: "Audit Log",
      desc: "See all API key usage",
      badge: "Visible",
    },
    {
      icon: "🚨",
      title: "Alerts",
      desc: "Alert on suspicious usage",
      badge: "Protected",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Create manage rotate API keys · Scoped permissions · Audit log
        </p>
      </div>
