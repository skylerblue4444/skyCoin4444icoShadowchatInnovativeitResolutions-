...
export default function ShadowTRUMPCoinHub() {
  ...
  const items = [
    ...
    },
    {
      icon: "⛏️",
      title: "Mine TRUMP",
      desc: "Mine TRUMP with CPU",
      badge: "Earn",
    },
    {
      icon: "💰",
      title: "Trade TRUMP",
      desc: "TRUMP/USDT TRUMP/BTC pairs",
      badge: "Trade",
    },
    {
      icon: "👛",
      title: "TRUMP Wallet",
      desc: "Dedicated TRUMP wallet",
      badge: "Hold",
    },
    {
      icon: "📊",
      title: "TRUMP Chart",
      desc: "Live TRUMP price chart",
      badge: "Track",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "TRUMP-SKY4444 trading pair",
      badge: "Pair",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Official TRUMP coin trading · Mining · Wallet · Community
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The home of TRUMP coin on ShadowChat.
          </p>
