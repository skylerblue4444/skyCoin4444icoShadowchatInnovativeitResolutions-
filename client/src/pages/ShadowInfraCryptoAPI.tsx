  ...
  const items = [
    {
      icon: "⚡",
      title: "Real-Time",
      desc: "Live price and market data",
      badge: "Instant",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "🪙",
      title: "10K+ Coins",
      desc: "Data for every coin",
      badge: "Wide",
    },
    {
      icon: "🔌",
      title: "REST WebSocket",
      desc: "REST and WebSocket APIs",
      badge: "Flexible",
    },
    {
      icon: "📈",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Real-time and historical data · 10,000+ coins · 99.99% uptime
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The most reliable crypto data API.
          </p>
