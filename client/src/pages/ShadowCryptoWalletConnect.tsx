  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🔗 WalletConnect Hub</h1>
          <p className="text-sm text-muted-foreground">
            Connect any Web3 wallet to ShadowChat — MetaMask, Phantom, Ledger,
            Trezor, and 200+ more
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            ...
            <p className="text-xs text-muted-foreground">Daily Connections</p>
          </CardContent>
        </Card>
      </div>
