  ...
  const items = [
    {
      icon: "🌐",
      title: "SD-WAN",
      desc: "Software-defined WAN",
      badge: "Modern",
    },
    {
      icon: "📶",
      title: "WiFi 6",
      desc: "Latest WiFi 6 deployment",
      badge: "Fast",
    },
    {
      icon: "🔌",
      title: "Switching",
      desc: "Managed switch deployment",
      badge: "Core",
    },
    {
      icon: "🛡️",
      title: "Firewall",
      desc: "Next-gen firewall",
      badge: "Secure",
    },
    {
      icon: "📊",
      title: "Monitoring",
      desc: "24/7 network monitoring",
      badge: "Visible",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Design build manage networks · SD-WAN · WiFi 6 · Arkansas
        </p>
      </div>
