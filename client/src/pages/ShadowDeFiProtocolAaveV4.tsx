  ...
  const items = [
    {
      icon: "👻",
      title: "Aave V4",
      desc: "Latest Aave version",
      badge: "Cutting-edge",
    },
    {
      icon: "🌊",
      title: "Unified Liquidity",
      desc: "Single liquidity layer",
      badge: "Efficient",
    },
    {
      icon: "🌉",
      title: "Cross-Chain",
      desc: "Borrow across chains",
      badge: "Universal",
    },
    {
      icon: "💰",
      title: "Best Rates",
      desc: "Competitive lending rates",
      badge: "Optimal",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Aave V4 analytics",
      badge: "Data",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 on Aave V4",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Lend borrow on Aave V4 · Unified liquidity · Cross-chain
        </p>
      </div>
