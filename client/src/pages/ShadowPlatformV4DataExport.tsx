  ...
  const items = [
    {
      icon: "📤",
      title: "Full Export",
      desc: "Export all your platform data",
      badge: "Complete",
    },
    {
      icon: "🔐",
      title: "GDPR",
      desc: "GDPR right to data portability",
      badge: "Compliant",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "⏰",
      title: "Scheduled",
      desc: "Schedule automatic exports",
      badge: "Automated",
    },
    {
      icon: "🔒",
      title: "Encrypted",
      desc: "Exports are encrypted",
      badge: "Secure",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 transaction export",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Export all your data · GDPR compliant · Any format
        </p>
      </div>
