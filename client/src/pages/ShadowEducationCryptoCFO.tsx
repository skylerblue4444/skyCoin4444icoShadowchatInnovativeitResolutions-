  ...
  const items = [
    {
      icon: "💰",
      title: "Treasury Mgmt",
      desc: "Manage crypto treasury",
      badge: "Strategic",
    },
    {
      icon: "📊",
      title: "Financial Reports",
      desc: "Crypto financial reporting",
      badge: "Compliant",
    },
    {
      icon: "🏦",
      title: "Banking",
      desc: "Crypto banking relationships",
      badge: "Practical",
    },
    {
      icon: "💳",
      title: "Payroll",
      desc: "Pay employees in crypto",
      badge: "Modern",
    },
    {
      icon: "📄",
      title: "Tax Strategy",
      desc: "Crypto tax optimization",
      badge: "Smart",
    },
    {
      icon: "💰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Financial management for crypto companies · Treasury · Tax
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The CFO program for the crypto age.
          </p>
