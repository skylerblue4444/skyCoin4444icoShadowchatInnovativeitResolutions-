  ...
  const items = [
    {
      icon: "🏗️",
      title: "ShadowChat",
      desc: "1800+ page crypto platform",
      badge: "Flagship",
    },
    {
      icon: "🛡️",
      title: "Security Projects",
      desc: "Cybersecurity implementations",
      badge: "Expertise",
    },
    {
      icon: "☁️",
      title: "Cloud Projects",
      desc: "Cloud migrations completed",
      badge: "Experience",
    },
    {
      icon: "🌐",
      title: "Network Projects",
      desc: "Network infrastructure built",
      badge: "Skills",
    },
    {
      icon: "💻",
      title: "Dev Projects",
      desc: "Custom software developed",
      badge: "Code",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Projects built · Clients served · Technologies mastered
        </p>
      </div>
