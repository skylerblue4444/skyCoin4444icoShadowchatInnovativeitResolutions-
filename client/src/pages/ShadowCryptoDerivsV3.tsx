...
export default function ShadowCryptoDerivsV3() {
  ...
  const items = [
    ...
    },
    {
      icon: "📐",
      title: "Delta Hedge",
      desc: "Delta hedging levels",
      badge: "Technical",
    },
    {
      icon: "🌋",
      title: "Vol Surface",
      desc: "3D volatility surface",
      badge: "Visual",
    },
    {
      icon: "💰",
      title: "Max Pain",
      desc: "Options max pain level",
      badge: "Insight",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Options flow · Gamma exposure · Delta hedging · Vol surface
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Trade derivatives with professional-grade data.
          </p>
