...
export default function ShadowITEnterpriseCloud() {
  ...
  const items = [
    ...
    },
    {
      icon: "🔵",
      title: "Azure",
      desc: "Microsoft Azure migration",
      badge: "Enterprise",
    },
    {
      icon: "🟡",
      title: "GCP",
      desc: "Google Cloud migration",
      badge: "Innovation",
    },
    {
      icon: "⚡",
      title: "Zero Downtime",
      desc: "Migrate without disruption",
      badge: "Safe",
    },
    {
      icon: "💰",
      title: "Save 40%",
      desc: "vs on-premise infrastructure",
      badge: "Cost",
    },
    {
      icon: "📞",
      title: "Plan",
      desc: "479-406-7123 for plan",
      badge: "Contact",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Move to cloud · AWS Azure GCP · Zero downtime · Arkansas
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Move to cloud. Save money. Scale faster.
          </p>
