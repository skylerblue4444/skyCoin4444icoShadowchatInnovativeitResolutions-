  ...
  const items = [
    {
      icon: "📄",
      title: "Legal Docs",
      desc: "Crypto will and testament",
      badge: "Official",
    },
    {
      icon: "🔑",
      title: "Key Transfer",
      desc: "Secure key transfer to heirs",
      badge: "Safe",
    },
    {
      icon: "⏰",
    ...
    },
    {
      icon: "👨‍👩‍👧",
      title: "Heirs",
      desc: "Designate multiple heirs",
      badge: "Flexible",
    },
    {
      icon: "🔐",
      title: "Encrypted",
      desc: "All docs encrypted",
      badge: "Private",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Pass your crypto to heirs · Dead man switch · Legal docs
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Make sure your crypto lives on.
          </p>
