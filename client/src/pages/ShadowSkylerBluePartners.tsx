  ...
  const items = [
    {
      icon: "🪟",
      title: "Microsoft",
      desc: "Microsoft partner reseller",
      badge: "Software",
    },
    {
      icon: "☁️",
      title: "AWS",
      desc: "Amazon Web Services partner",
      badge: "Cloud",
    },
    {
      icon: "🔵",
      title: "Cisco",
      desc: "Cisco reseller partner",
      badge: "Network",
    },
    {
      icon: "🛡️",
      title: "CrowdStrike",
      desc: "Security partner",
      badge: "Security",
    },
    {
      icon: "💾",
      title: "Dell",
      desc: "Dell hardware reseller",
      badge: "Hardware",
    },
    {
      icon: "📞",
      title: "Pricing",
      desc: "479-406-7123 for pricing",
      badge: "Contact",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Vendor partnerships · Reseller agreements · Best pricing
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Best prices through vendor partnerships.
          </p>
