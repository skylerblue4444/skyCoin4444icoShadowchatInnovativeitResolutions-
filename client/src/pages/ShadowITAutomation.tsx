  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Intelligent IT automation platform — runbooks, scripts, and
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">2,847hrs</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/30 to-violet-900/30 border border-indigo-500/20 p-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() =>
              toast.success("IT Automation activated! Welcome aboard.")
            }
          >
