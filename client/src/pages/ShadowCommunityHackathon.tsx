  ...
  const items = [
    {
      icon: "🏆",
      title: "$100K Pool",
      desc: "Massive prize pool",
      badge: "Motivating",
    },
    {
      icon: "⏰",
      title: "Quarterly",
      desc: "Hackathon every quarter",
      badge: "Regular",
    },
    {
      icon: "🔨",
    ...
    },
    {
      icon: "👥",
      title: "Teams",
      desc: "Solo or team participation",
      badge: "Flexible",
    },
    {
      icon: "🌍",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Build on SKY4444 · Win prizes · $100K prize pool · Quarterly
        </p>
      </div>
