      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Join the ShadowChat Community DAO — vote on features, allocate
            treasury funds, and shape the platform
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Your Voice</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-purple-400"}>84,247</p>
