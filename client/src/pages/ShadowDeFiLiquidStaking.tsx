  ...
  const items = [
    {
      icon: "💧",
      title: "Liquid Tokens",
      desc: "stETH stSOL stBNB",
      badge: "Liquid",
    },
    {
      icon: "💰",
      title: "Earn Yield",
      desc: "Staking yield while liquid",
      badge: "Both",
    },
    {
      icon: "🔄",
      title: "Use in DeFi",
      desc: "Use liquid tokens in DeFi",
      badge: "Composable",
    },
    {
      icon: "📊",
      title: "Best Rate",
      desc: "Compare staking rates",
      badge: "Optimal",
    },
    {
      icon: "🛡️",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Stake ETH SOL BNB · Get liquid tokens · Earn while liquid
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Stake and stay liquid at the same time.
          </p>
