  ...
  const items = [
    {
      icon: "🪟",
      title: "Windows",
      desc: "Native Windows application",
      badge: "Microsoft",
    },
    {
      icon: "🍎",
      title: "Mac",
      desc: "Native macOS application",
      badge: "Apple",
    },
    {
      icon: "🐧",
      title: "Linux",
      desc: "Native Linux application",
      badge: "Open",
    },
    {
      icon: "🖥️",
      title: "Multi-Monitor",
      desc: "Span across monitors",
      badge: "Pro",
    },
    {
      icon: "⚡",
      title: "Native Speed",
      desc: "Faster than browser",
      badge: "Performance",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Desktop mining widget",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Windows Mac Linux · Native performance · Multi-monitor
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Professional desktop trading environment.
          </p>
