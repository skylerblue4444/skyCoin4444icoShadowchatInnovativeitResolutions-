...
export default function ShadowCryptoGamingNFT() {
  ...
  const items = [
    { icon: "🗡️", title: "Weapons", desc: "Rare weapon NFTs", badge: "Combat" },
    {
      icon: "🛡️",
      title: "Armor",
      desc: "Legendary armor sets",
      badge: "Defense",
    },
    {
      icon: "🏠",
      title: "Land",
      desc: "Virtual land parcels",
      badge: "Estate",
    },
    {
      icon: "👤",
      title: "Characters",
      desc: "Unique character NFTs",
      badge: "Identity",
    },
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Buy sell trade gaming NFTs · All games · Best prices
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The best gaming NFT marketplace.
          </p>
