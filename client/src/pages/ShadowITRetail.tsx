  ...
  const items = [
    {
      icon: "🛒",
      title: "POS",
      desc: "Retail point of sale system",
      badge: "Core",
    },
    {
      icon: "📦",
    ...
    },
    {
      icon: "📷",
      title: "Cameras",
      desc: "Loss prevention cameras",
      badge: "Secure",
    },
    {
      icon: "📶",
      title: "WiFi",
      desc: "Store WiFi network",
      badge: "Connected",
    },
    {
      icon: "📊",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          POS inventory cameras WiFi · Arkansas retail · $199/mo
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            IT that helps retail stores sell more.
          </p>
