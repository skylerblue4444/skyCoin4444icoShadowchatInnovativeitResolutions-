...
export default function ShadowTradingRiskManager() {
  ...
  const items = [
    ...
    },
    {
      icon: "📉",
      title: "Max Drawdown",
      desc: "Set max drawdown limits",
      badge: "Protected",
    },
    {
      icon: "🎯",
      title: "Kelly Criterion",
      desc: "Kelly criterion calculator",
      badge: "Mathematical",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "🛡️",
      title: "Risk Score",
      desc: "Portfolio risk score",
      badge: "Aware",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 risk management",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Position sizing · Max drawdown · Kelly criterion · VaR
        </p>
      </div>
