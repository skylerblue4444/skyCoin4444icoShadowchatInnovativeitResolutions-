...
export default function ShadowSkylerBlueCertifications() {
  ...
  const items = [
    ...
    },
    {
      icon: "🪟",
      title: "Microsoft",
      desc: "Microsoft 365 certification",
      badge: "Cloud",
    },
    {
      icon: "🔵",
      title: "Cisco",
      desc: "CCNA networking",
      badge: "Enterprise",
    },
    {
      icon: "☁️",
      title: "AWS",
      desc: "Amazon cloud certification",
      badge: "Cloud",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          CompTIA Microsoft Cisco AWS certifications
        </p>
      </div>
