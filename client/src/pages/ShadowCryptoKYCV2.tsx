  ...
  const items = [
    {
      icon: "⚡",
      title: "Instant",
      desc: "Verify in under 60 seconds",
      badge: "Fast",
    },
    {
      icon: "🌍",
      title: "150 Countries",
      desc: "Global ID document support",
      badge: "Wide",
    },
    {
      icon: "🤖",
    ...
    },
    {
      icon: "🔐",
      title: "Privacy",
      desc: "Data encrypted and deleted",
      badge: "Safe",
    },
    {
      icon: "✅",
      title: "Compliant",
      desc: "FATF AML compliant",
      badge: "Legal",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "KYC unlocks SKY4444 limits",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Instant identity verification · 150 countries · AI-powered
        </p>
      </div>
