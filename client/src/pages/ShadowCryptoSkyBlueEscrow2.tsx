  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🤝 Smart Escrow 2.0</h1>
          <p className="text-sm text-muted-foreground">
            Advanced smart contract escrow for any deal — crypto, NFTs,
            services, and physical goods
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Safe Deals</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-orange-400"}>$847M</p>
            <p className="text-xs text-muted-foreground">Escrow Volume</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">24hrs</p>
