  ...
  const items = [
    {
      icon: "🍽️",
      title: "POS System",
      desc: "Point of sale setup",
      badge: "Essential",
    },
    {
      icon: "📶",
      title: "Guest WiFi",
      desc: "Customer WiFi network",
      badge: "Service",
    },
    {
      icon: "📷",
      title: "Cameras",
      desc: "Security camera system",
      badge: "Safe",
    },
    {
      icon: "📱",
      title: "Online Order",
      desc: "Online ordering integration",
      badge: "Revenue",
    },
    {
      icon: "💳",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          POS systems WiFi cameras · Arkansas restaurants · $149/mo
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            IT that helps restaurants run smoother.
          </p>
