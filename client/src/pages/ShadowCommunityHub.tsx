  ...
  const items = [
    {
      icon: "💬",
      title: "General Chat",
      desc: "Open discussion for all",
      badge: "Active",
    },
    {
      icon: "⛏️",
      title: "Miners Club",
      desc: "Share mining tips & wins",
      badge: "Hot",
    },
    {
      icon: "📈",
      title: "Traders Lounge",
      desc: "Signals · Analysis · Calls",
      badge: "Live",
    },
    {
      icon: "🛒",
      title: "Shop Reviews",
      desc: "Rate products · Help others",
      badge: "Helpful",
    },
    {
      icon: "🎓",
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Connect · Discuss · Learn · Earn SKY4444 together
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Join the ShadowChat community. Earn SKY4444 for every contribution.
          </p>
