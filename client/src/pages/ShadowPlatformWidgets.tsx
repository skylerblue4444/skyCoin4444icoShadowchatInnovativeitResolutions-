  ...
  const items = [
    {
      icon: "📊",
      title: "Price Widget",
      desc: "Live price ticker widget",
      badge: "Essential",
    },
    {
      icon: "⛏️",
      title: "Mining Widget",
      desc: "Mining stats widget",
      badge: "Earn",
    },
    {
      icon: "💰",
      title: "Portfolio Widget",
      desc: "Portfolio value widget",
      badge: "Track",
    },
    {
      icon: "🔔",
      title: "Alert Widget",
      desc: "Active alerts widget",
      badge: "Aware",
    },
    {
      icon: "📰",
      title: "News Widget",
      desc: "Latest news widget",
      badge: "Informed",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 balance widget",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Drag and drop widgets · Customize your dashboard · Save layouts
        </p>
      </div>
