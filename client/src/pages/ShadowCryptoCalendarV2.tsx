  ...
  const items = [
    {
      icon: "📅",
      title: "All Events",
      desc: "Every crypto event in one place",
      badge: "Complete",
    },
    {
      icon: "🔓",
      title: "Token Unlocks",
      desc: "Vesting unlock schedule",
      badge: "Risk",
    },
    {
      icon: "📊",
      title: "Earnings",
      desc: "Protocol revenue reports",
      badge: "Fundamental",
    },
    {
      icon: "🎤",
      title: "Conferences",
      desc: "Crypto conference calendar",
      badge: "Network",
    },
    {
      icon: "🚀",
      title: "Launches",
      desc: "New token launch dates",
      badge: "Opportunity",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          All crypto events · Earnings · Unlocks · Conferences · Launches
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Never miss an important crypto event.
          </p>
