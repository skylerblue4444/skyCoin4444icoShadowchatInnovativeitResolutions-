  ...
  const items = [
    {
      icon: "🛑",
      title: "Stop Loss",
      desc: "Automatic stop loss orders",
      badge: "Protect",
    },
    {
      icon: "📈",
      title: "Take Profit",
      desc: "Automatic take profit orders",
      badge: "Lock In",
    },
    {
      icon: "🔄",
      title: "Trailing Stop",
      desc: "Dynamic trailing stop loss",
      badge: "Smart",
    },
    {
      icon: "⚖️",
      title: "OCO",
      desc: "One-cancels-other orders",
      badge: "Advanced",
    },
    {
      icon: "📊",
      title: "Bracket",
      desc: "Full bracket order system",
      badge: "Complete",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "All order types for SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Stop limit trailing stop OCO bracket orders · All exchanges
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Professional order types for every trader.
          </p>
