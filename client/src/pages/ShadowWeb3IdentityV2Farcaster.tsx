  ...
  const items = [
    {
      icon: "📡",
      title: "Channels",
      desc: "Join crypto channels",
      badge: "Community",
    },
    {
      icon: "🖼️",
      title: "Frames",
      desc: "Interactive Farcaster frames",
      badge: "Engage",
    },
    {
      icon: "📝",
      title: "Casts",
      desc: "Post and reply to casts",
      badge: "Communicate",
    },
    {
      icon: "🔗",
      title: "Warpcast",
      desc: "Warpcast integration",
      badge: "Popular",
    },
    {
      icon: "💰",
      title: "Earn",
      desc: "Earn from your casts",
      badge: "Monetize",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 on Farcaster",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Farcaster channels · Frames · Casts · Warpcast integration
        </p>
      </div>
