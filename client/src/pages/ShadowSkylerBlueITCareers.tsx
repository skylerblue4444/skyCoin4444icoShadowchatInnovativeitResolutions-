  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">💼 IT Careers</h1>
          <p className="text-sm text-muted-foreground">
            Career opportunities at Skyler Blue IT Resolutions — join Arkansas's
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">$87K</p>
            <p className="text-xs text-muted-foreground">Avg Salary</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">Full Package</p>
