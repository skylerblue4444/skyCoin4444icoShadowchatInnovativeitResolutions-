  ...
  const items = [
    {
      icon: "🙋",
      title: "Anyone",
      desc: "No experience needed",
      badge: "Accessible",
    },
    {
      icon: "📱",
      title: "Simple",
      desc: "Explained in plain English",
      badge: "Clear",
    },
    {
      icon: "⛏️",
      title: "Start Mining",
      desc: "Mine SKY4444 in 5 minutes",
      badge: "Easy",
    },
    {
      icon: "💰",
    ...
    },
    {
      icon: "📞",
      title: "Help",
      desc: "479-406-7123 for help",
      badge: "Supported",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Start with free SKY4444",
      badge: "Gift",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Simple crypto guide for beginners · No jargon · Start today
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Crypto is for everyone. Start today.
          </p>
