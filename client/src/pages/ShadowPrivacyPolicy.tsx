...
export default function ShadowPrivacyPolicy() {
  const items = [
    ...
    },
    {
      icon: "🌍",
      title: "GDPR",
      desc: "EU users fully protected",
      badge: "Compliant",
    },
    {
      icon: "🇺🇸",
      title: "CCPA",
      desc: "California users protected",
      badge: "Compliant",
    },
    {
      icon: "🗑️",
      title: "Delete Account",
      desc: "Full data deletion on request",
      badge: "Your right",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Your data · How we use it · Your rights · GDPR · CCPA
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Your privacy matters. We collect only what we need.
          </p>
