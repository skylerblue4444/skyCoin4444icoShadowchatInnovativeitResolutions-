  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">📈 Platform Metrics</h1>
          <p className="text-sm text-muted-foreground">
            Real-time ShadowChat platform metrics — users, volume, transactions,
            and growth
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Live Stats</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">$12.7B</p>
            <p className="text-xs text-muted-foreground">Daily Volume</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">4.7M</p>
