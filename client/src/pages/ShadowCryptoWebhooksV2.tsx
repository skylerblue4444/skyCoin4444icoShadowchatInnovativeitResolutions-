  ...
  const items = [
    {
      icon: "⚡",
      title: "Real-Time",
      desc: "Events delivered instantly",
      badge: "Live",
    },
    {
      icon: "🔄",
      title: "Retry",
      desc: "Auto-retry on failure",
      badge: "Reliable",
    },
    {
      icon: "🔐",
      title: "Signature",
      desc: "HMAC signature verification",
      badge: "Secure",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 transaction webhooks",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Real-time event delivery · Retry logic · Signature verification
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Build reactive apps with webhooks.
          </p>
