  ...
  const items = [
    {
      icon: "⛏️",
      title: "Halvings",
      desc: "All upcoming halvings",
      badge: "Major",
    },
    {
      icon: "🔓",
      title: "Unlocks",
      desc: "Token unlock schedule",
      badge: "Risk",
    },
    {
      icon: "📋",
      title: "Listings",
      desc: "New exchange listings",
      badge: "Opportunity",
    },
    {
      icon: "🎁",
      title: "Airdrops",
      desc: "Upcoming airdrop calendar",
      badge: "Free",
    },
    {
      icon: "🔔",
      title: "Alerts",
      desc: "Event reminder alerts",
      badge: "Notified",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 event calendar",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Halvings unlocks listings airdrops · All chains · Alerts
        </p>
      </div>
