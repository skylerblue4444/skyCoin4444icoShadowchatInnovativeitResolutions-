  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">💧 Liquidity Provider Hub</h1>
          <p className="text-sm text-muted-foreground">
            Provide liquidity to ShadowDEX pools and earn trading fees plus
            SKY4444 mining rewards
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Earn Fees</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-blue-400"}>$0</p>
            <p className="text-xs text-muted-foreground">Your LP Value</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">$0</p>
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            ...
            <p className="text-xs text-muted-foreground">Best Pool APY</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">847</p>
