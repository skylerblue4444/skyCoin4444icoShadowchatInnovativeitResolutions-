...
export default function ShadowCryptoGovernanceV2() {
  ...
  const items = [
    ...
    },
    {
      icon: "📋",
      title: "Proposals",
      desc: "Create governance proposals",
      badge: "Participate",
    },
    {
      icon: "📊",
      title: "Quorum",
      desc: "Track quorum requirements",
      badge: "Informed",
    },
    {
      icon: "🏛️",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 governance voting",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Vote on protocol changes · Delegate · Proposals · Quorum
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Your tokens. Your vote. Your protocol.
          </p>
