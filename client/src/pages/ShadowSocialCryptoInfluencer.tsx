  ...
  const items = [
    {
      ...
      desc: "Grow your crypto following",
      badge: "Grow",
    },
    {
      icon: "💰",
      title: "Monetize",
      desc: "Multiple monetization streams",
      badge: "Earn",
    },
    {
      icon: "🤝",
      title: "Brand Deals",
      desc: "Connect with crypto brands",
      badge: "Partner",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Track your influence metrics",
      badge: "Data",
    },
    {
      icon: "🏆",
      title: "Rankings",
      desc: "Top crypto influencer rankings",
      badge: "Compete",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Earn SKY4444 from fans",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Build your crypto audience · Monetize · Brand deals · SKY4444
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Become the next crypto influencer.
          </p>
