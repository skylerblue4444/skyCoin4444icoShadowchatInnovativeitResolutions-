  ...
  const items = [
    {
      icon: "♾️",
      title: "Perpetuals",
      desc: "Perpetual futures contracts",
      badge: "Popular",
    },
    {
      icon: "📅",
      title: "Dated",
      desc: "Quarterly futures contracts",
      badge: "Structured",
    },
    {
      icon: "💥",
      title: "100x Leverage",
      desc: "Up to 100x leverage",
      badge: "Power",
    },
    {
      icon: "🛡️",
      title: "Risk Mgmt",
      desc: "Auto stop-loss and TP",
      badge: "Protected",
    },
    {
      icon: "📊",
      title: "Funding Rate",
      desc: "Real-time funding rates",
      badge: "Cost",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 perpetual futures",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Perpetual and dated futures · Up to 100x leverage · All coins
        </p>
      </div>
