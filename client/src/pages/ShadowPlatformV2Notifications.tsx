  ...
  const items = [
    {
      icon: "🤖",
      title: "AI Filter",
      desc: "Only important alerts shown",
      badge: "Smart",
    },
    {
      icon: "🏆",
      title: "Priority",
      desc: "High medium low priority",
      badge: "Ranked",
    },
    {
      icon: "⛏️",
      title: "Mining",
      desc: "Mining reward notifications",
      badge: "Earn",
    },
    {
      icon: "💰",
      title: "Trading",
      desc: "Trade execution alerts",
      badge: "Aware",
    },
    {
      icon: "🔔",
      title: "Price",
      desc: "Price target alerts",
      badge: "Precise",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 alerts first",
      badge: "Priority",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          All alerts in one place · AI-filtered · Priority ranked
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The smartest notification system in crypto.
          </p>
