...
export default function ShadowPlatformV4TwoFA() {
  ...
  const items = [
    ...
    },
    {
      icon: "📧",
      title: "Email 2FA",
      desc: "Email verification backup",
      badge: "Backup",
    },
    {
      icon: "🛡️",
      title: "Phishing Proof",
      desc: "Phishing-resistant 2FA",
      badge: "Safe",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "2FA protects SKY4444 wallet",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Protect your account · TOTP · Hardware keys · Biometric
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Lock down your account completely.
          </p>
