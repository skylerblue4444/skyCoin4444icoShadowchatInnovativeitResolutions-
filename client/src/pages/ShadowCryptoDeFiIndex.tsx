  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">📊 DeFi Index Fund</h1>
          <p className="text-sm text-muted-foreground">
            Invest in the top DeFi protocols with one click — the ShadowDeFi
            Index automatically rebalances monthly
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Diversified</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-green-400"}>$247M</p>
            <p className="text-xs text-muted-foreground">Index AUM</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
