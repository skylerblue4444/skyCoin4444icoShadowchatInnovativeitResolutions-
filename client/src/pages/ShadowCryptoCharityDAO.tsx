  ...
  const items = [
    {
      icon: "❤️",
      title: "Donate",
      desc: "Donate any crypto to charity",
      badge: "Generous",
    },
    {
      icon: "🏛️",
      title: "DAO Votes",
      desc: "Community votes on causes",
      badge: "Democratic",
    },
    {
      icon: "📊",
      title: "Transparent",
      desc: "All donations on-chain",
      badge: "Open",
    },
    {
      icon: "🌍",
      title: "Global Causes",
      desc: "Support causes worldwide",
      badge: "Impact",
    },
    {
      icon: "💰",
      title: "Tax Deductible",
      desc: "Crypto donation receipts",
      badge: "Benefit",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Donate crypto · Transparent · Community votes on causes
        </p>
      </div>
