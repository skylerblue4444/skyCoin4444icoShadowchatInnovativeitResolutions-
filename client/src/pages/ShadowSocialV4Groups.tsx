  ...
  const items = [
    {
      icon: "🌐",
      title: "Public Groups",
      desc: "Open to all members",
      badge: "Accessible",
    },
    {
      icon: "🔐",
      title: "Private Groups",
      desc: "Invite-only groups",
      badge: "Exclusive",
    },
    {
      icon: "✦",
      title: "SKY4444 Gate",
      desc: "Hold SKY4444 to join",
      badge: "Gated",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Group growth analytics",
      badge: "Data",
    },
    {
      icon: "🏆",
      title: "Top Groups",
      desc: "Most active groups",
      badge: "Popular",
    },
    {
      icon: "💰",
      title: "Earn",
      desc: "Group owners earn SKY4444",
      badge: "Incentive",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Public and private groups · Topic-based · SKY4444 gated
        </p>
      </div>
