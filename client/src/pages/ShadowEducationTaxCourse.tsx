  ...
  const items = [
    {
      icon: "🇺🇸",
      title: "USA Taxes",
      desc: "IRS Form 8949 guide",
      badge: "Required",
    },
    {
      icon: "🇬🇧",
      title: "UK Taxes",
      desc: "HMRC self-assessment",
      badge: "Required",
    },
    {
      icon: "🇩🇪",
      title: "Germany",
      desc: "BaFin tax filing",
      badge: "Required",
    },
    {
      icon: "💡",
      title: "Tax Loss",
      desc: "Harvest tax losses legally",
      badge: "Smart",
    },
    {
      icon: "📊",
      title: "Software",
      desc: "Best crypto tax software",
      badge: "Tools",
    },
    {
      icon: "💰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Report crypto taxes correctly · Every country · Save money
        </p>
      </div>
