  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🛡️ Crypto Insurance 2.0</h1>
          <p className="text-sm text-muted-foreground">
            Comprehensive crypto insurance — wallet coverage, smart contract
            bugs, exchange hacks, and DeFi risks
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">0.47%/yr</p>
