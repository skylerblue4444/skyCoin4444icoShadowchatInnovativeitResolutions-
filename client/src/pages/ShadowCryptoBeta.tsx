  ...
  const items = [
    {
      icon: "📊",
      title: "Beta Score",
      desc: "Volatility vs BTC",
      badge: "Measured",
    },
    {
      icon: "📈",
      title: "High Beta",
      desc: "More volatile than BTC",
      badge: "Risky",
    },
    {
      icon: "📉",
      title: "Low Beta",
      desc: "Less volatile than BTC",
      badge: "Stable",
    },
    {
      icon: "🛡️",
      title: "Risk Rating",
      desc: "1-10 risk score",
      badge: "Clear",
    },
    {
      icon: "📅",
      title: "Historical",
      desc: "Rolling beta calculation",
      badge: "Dynamic",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 beta tracking",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Measure coin volatility vs Bitcoin · Risk assessment
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Know exactly how risky each coin is.
          </p>
