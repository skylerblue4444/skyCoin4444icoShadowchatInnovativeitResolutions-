  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🎙️ Voice & Unified Comms</h1>
          <p className="text-sm text-muted-foreground">
            Unified communications for Arkansas businesses — voice, video,
            messaging, and collaboration in one platform
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-indigo-400"}>4,247</p>
            <p className="text-xs text-muted-foreground">UC Users</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">847/day</p>
