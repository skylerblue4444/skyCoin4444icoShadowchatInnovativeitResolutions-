  ...
  const items = [
    {
      icon: "📊",
      title: "MVRV",
      desc: "Market value to realized value",
      badge: "Valuation",
    },
    {
      icon: "📈",
    ...
    },
    {
      icon: "👥",
      title: "Active Addr",
      desc: "Daily active addresses",
      badge: "Adoption",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "On-chain metrics for SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          MVRV NVT SOPR NUPL active addresses · Deep analysis
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The deepest on-chain analysis available.
          </p>
