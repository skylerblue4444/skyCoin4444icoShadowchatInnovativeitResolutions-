...
export default function ShadowPlatformAPIV3() {
  ...
  const items = [
    { icon: "🔷", title: "GraphQL", desc: "Full GraphQL API", badge: "Modern" },
    {
      icon: "🔄",
      title: "Subscriptions",
      desc: "Real-time GraphQL subscriptions",
      badge: "Live",
    },
    {
      icon: "🪝",
      title: "Webhooks",
      desc: "Event-driven webhooks",
      badge: "Automated",
    },
    {
      icon: "📦",
      title: "SDK",
      desc: "JavaScript Python SDK",
      badge: "Developer",
    },
    {
      icon: "📋",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          GraphQL API · Real-time subscriptions · Webhooks · SDK
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Build anything on top of ShadowChat.
          </p>
