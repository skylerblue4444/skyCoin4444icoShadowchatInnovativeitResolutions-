      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Zero trust security architecture for Arkansas businesses — verify
            every user, device, and connection
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Never Trust</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            ...
            <p className="text-xs text-muted-foreground">Trust Policies</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">4.7M/mo</p>
