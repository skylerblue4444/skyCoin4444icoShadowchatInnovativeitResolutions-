...
export default function ShadowStablecoinHub() {
  const items = [
    ...
    { icon: "🔵", title: "USDC", desc: "Circle · Regulated", badge: "Trusted" },
    {
      icon: "🌈",
      title: "DAI",
      desc: "MakerDAO · Decentralized",
      badge: "DeFi",
    },
    {
      icon: "📊",
      title: "Yield",
      desc: "Up to 12% APY on stables",
      badge: "Earn",
    },
    {
      icon: "🔄",
      title: "Swap",
      desc: "Swap between stablecoins",
      badge: "Flexible",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Stable-SKY4444 pairs",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          USDT USDC DAI FRAX TUSD · Yield · Swap · Bridge
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Everything you need for stablecoins.
          </p>
