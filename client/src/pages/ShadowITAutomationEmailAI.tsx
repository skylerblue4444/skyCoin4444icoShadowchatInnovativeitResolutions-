  ...
  const items = [
    {
      icon: "📧",
      title: "Auto-Respond",
      desc: "AI responds to common emails",
      badge: "Efficient",
    },
    {
      icon: "🏷️",
      title: "Classify",
      desc: "Auto-classify incoming emails",
      badge: "Organized",
    },
    {
      icon: "🔀",
      title: "Route",
      desc: "Route emails to right person",
      badge: "Smart",
    },
    {
      icon: "📝",
      title: "Summarize",
      desc: "AI summarizes long emails",
      badge: "Quick",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Email performance metrics",
      badge: "Visible",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Auto-respond to emails · Classify · Route · Summarize
        </p>
      </div>
