...
export default function ShadowEducationNFTCreator() {
  ...
  const items = [
    ...
    },
    {
      icon: "🎬",
      title: "Video NFTs",
      desc: "Video NFT creation guide",
      badge: "Creator",
    },
    {
      icon: "💰",
      title: "Royalties",
      desc: "Earn royalties forever",
      badge: "Passive",
    },
    {
      icon: "🛒",
      title: "Sell",
      desc: "Sell on OpenSea Blur Magic Eden",
      badge: "Market",
    },
    {
      icon: "💰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Create sell NFTs · Art music video · Royalties · Platforms
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Turn your creativity into crypto.
          </p>
