...
export default function ShadowCryptoIdentityV2() {
  ...
  const items = [
    ...
    },
    {
      icon: "✅",
      title: "Credentials",
      desc: "Verifiable credentials",
      badge: "Trusted",
    },
    {
      icon: "🔐",
      title: "Self-Sovereign",
      desc: "You control your identity",
      badge: "Yours",
    },
    {
      icon: "🌍",
      title: "Portable",
      desc: "Use identity anywhere",
      badge: "Universal",
    },
    {
      icon: "🛡️",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 identity integration",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Self-sovereign identity · Verifiable credentials · DID
        </p>
      </div>
