  ...
  const items = [
    {
      icon: "🌍",
      title: "Democratize",
      desc: "Crypto for everyone everywhere",
      badge: "Universal",
    },
    {
      icon: "💪",
      title: "Empower",
      desc: "Empower financial freedom",
      badge: "Purpose",
    },
    {
      icon: "🔐",
      title: "Secure",
      desc: "Security first always",
      badge: "Safe",
    },
    {
      icon: "🤝",
      title: "Community",
      desc: "Community-first approach",
      badge: "People",
    },
    {
      icon: "🙏",
      title: "Faith",
      desc: "Built with faith and integrity",
      badge: "Values",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 is the mission",
      badge: "Core",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Democratize crypto · Empower everyone · Build with faith
        </p>
      </div>
