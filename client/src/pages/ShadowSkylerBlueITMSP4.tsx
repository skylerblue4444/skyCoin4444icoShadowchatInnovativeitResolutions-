  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">⭐ MSP Enterprise</h1>
          <p className="text-sm text-muted-foreground">
            The ultimate enterprise MSP package — dedicated team, custom SLA,
            vCISO, CTO advisory, and full IT ownership
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Top Tier</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-yellow-400"}>4</p>
