...
export default function ShadowEcosystemCosmos() {
  ...
  const items = [
    ...
    },
    {
      icon: "🔗",
      title: "App Chains",
      desc: "Cosmos app chain ecosystem",
      badge: "Specialized",
    },
    {
      icon: "🌉",
      title: "Interop",
      desc: "Interoperability hub",
      badge: "Universal",
    },
    {
      icon: "💰",
      title: "Trade ATOM",
      desc: "ATOM trading pairs",
      badge: "Trade",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Cosmos ecosystem analytics",
      badge: "Data",
    },
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          ATOM IBC · App chains · Interoperability · Growing DeFi
        </p>
      </div>
