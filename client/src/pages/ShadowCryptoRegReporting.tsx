  ...
  const items = [
    {
      icon: "🇺🇸",
      title: "IRS 8949",
      desc: "US crypto tax form",
      badge: "Required",
    },
    {
      icon: "🇪🇺",
      title: "DAC8",
      desc: "EU crypto reporting",
      badge: "Required",
    },
    {
      icon: "🇬🇧",
      title: "HMRC",
      desc: "UK crypto reporting",
      badge: "Required",
    },
    {
      icon: "📊",
      title: "Auto-Generate",
      desc: "Reports generated automatically",
      badge: "Easy",
    },
    {
      icon: "📤",
      title: "Export",
      desc: "Export to any format",
      badge: "Flexible",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 reporting included",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Automated tax and regulatory reports · 50 countries
        </p>
      </div>
