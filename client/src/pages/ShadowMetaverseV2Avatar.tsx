  ...
  const items = [
    {
      icon: "🧑",
      title: "3D Avatar",
      desc: "Create your digital self",
      badge: "Identity",
    },
    {
      icon: "👗",
      title: "Wearables",
      desc: "NFT clothing and accessories",
      badge: "Fashion",
    },
    {
      icon: "🌐",
      title: "Cross-Platform",
      desc: "Use avatar everywhere",
      badge: "Universal",
    },
    {
      icon: "🎨",
    ...
    },
    {
      icon: "💰",
      title: "Sell",
      desc: "Sell avatar items as NFTs",
      badge: "Earn",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Buy wearables with SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Create your 3D avatar · NFT wearables · Cross-platform
        </p>
      </div>
