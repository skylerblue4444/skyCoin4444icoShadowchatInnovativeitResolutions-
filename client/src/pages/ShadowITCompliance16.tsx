    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Advanced compliance management for HIPAA, SOC2, ISO27001, PCI-DSS,
            and FedRAMP
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-green-400"}>16</p>
            <p className="text-xs text-muted-foreground">Frameworks</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">2,847</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">
          Compliance Suite 16 — Get Started Today
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActivated(true);
              toast.success(
                "Compliance Suite 16 activated! Enjoy your new features."
              );
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() =>
              toast.info("Opening Compliance Suite 16 documentation...")
            }
          >
