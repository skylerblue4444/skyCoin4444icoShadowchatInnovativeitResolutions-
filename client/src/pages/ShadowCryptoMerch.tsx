...
export default function ShadowCryptoMerch() {
  const items = [
    {
      icon: "👕",
      title: "SKY4444 Hoodie",
      desc: "Limited edition · $44.44",
      badge: "Hot",
    },
    {
      icon: "🧢",
      title: "TRUMP Crypto Cap",
      desc: "Official · $24.99",
      badge: "Popular",
    },
    {
    ...
    },
    {
      ...
      desc: "Mining rig bag · $49.99",
      badge: "Useful",
    },
    {
      icon: "🔑",
      title: "Hardware Wallet",
      desc: "Secure your coins · $79.99",
      badge: "Essential",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Bitcoin · TRUMP · SKY4444 · DOGE branded products
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Wear your crypto. SKY4444 payments accepted. Ships worldwide.
          </p>
