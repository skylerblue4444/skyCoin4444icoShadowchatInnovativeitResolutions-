  ...
  const items = [
    {
      icon: "🌍",
      title: "Global",
      desc: "Regulation in 100+ countries",
      badge: "Comprehensive",
    },
    {
      icon: "🇺🇸",
      title: "USA",
      desc: "SEC CFTC IRS updates",
      badge: "Critical",
    },
    {
      icon: "🇪🇺",
      title: "Europe",
      desc: "MiCA and EU regulation",
      badge: "Important",
    },
    {
      icon: "🇨🇳",
      title: "China",
      desc: "China crypto policy updates",
      badge: "Monitor",
    },
    {
      icon: "🔔",
      title: "Alerts",
      desc: "Alert on regulation changes",
      badge: "Aware",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Global crypto regulation · Country-by-country · Updates
        </p>
      </div>
