  ...
  const items = [
    {
      icon: "🥇",
      title: "Gold",
      desc: "Tokenized physical gold",
      badge: "Store of Value",
    },
    {
      icon: "🥈",
      title: "Silver",
      desc: "Tokenized physical silver",
      badge: "Hedge",
    },
    {
      icon: "🛢️",
      title: "Oil",
      desc: "Tokenized oil contracts",
      badge: "Commodity",
    },
    {
      icon: "🌾",
      title: "Agriculture",
      desc: "Tokenized farm commodities",
      badge: "Diversify",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Buy commodities with SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Gold silver oil on-chain · Physical backing · Instant trade
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Own real commodities digitally.
          </p>
