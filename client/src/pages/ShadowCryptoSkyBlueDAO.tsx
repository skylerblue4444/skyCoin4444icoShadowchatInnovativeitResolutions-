  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🏛️ SkyBlue DAO</h1>
          <p className="text-sm text-muted-foreground">
            The official SkyBlue DAO — vote on platform decisions, treasury
            allocation, and SKY4444 tokenomics
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Governance</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-cyan-400"}>84,247</p>
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">.7M</p>
