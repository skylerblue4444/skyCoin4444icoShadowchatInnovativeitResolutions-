  ...
  const items = [
    {
      icon: "🔄",
      title: "Auto-Patch",
      desc: "Patches applied automatically",
      badge: "Hands-free",
    },
    {
      icon: "🪟",
      title: "Windows",
      desc: "Windows Server and desktop",
      badge: "Microsoft",
    },
    {
      icon: "🐧",
      title: "Linux",
      desc: "All major Linux distros",
      badge: "Open",
    },
    {
      icon: "🍎",
      title: "Mac",
      desc: "macOS fleet management",
      badge: "Apple",
    },
    {
      icon: "📊",
      title: "Reports",
      desc: "Patch compliance reports",
      badge: "Compliant",
    },
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Automated patching · Windows Linux Mac · Compliance reports
        </p>
      </div>
