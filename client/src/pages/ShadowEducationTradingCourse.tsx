  ...
  const items = [
    {
      ...
      desc: "Charts patterns indicators",
      badge: "Skills",
    },
    {
      icon: "💰",
      title: "Risk Management",
      desc: "Never blow up your account",
      badge: "Safe",
    },
    {
      icon: "🎯",
      title: "Strategy",
      desc: "Build your trading strategy",
      badge: "System",
    },
    {
      icon: "📝",
      title: "Journal",
      desc: "Keep a trading journal",
      badge: "Discipline",
    },
    {
      icon: "🏆",
      title: "Certificate",
      desc: "Trader certification",
      badge: "Credible",
    },
    {
      icon: "💰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Learn to trade crypto · Technical analysis · Risk management
        </p>
      </div>
