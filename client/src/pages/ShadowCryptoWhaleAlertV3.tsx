  ...
  const items = [
    {
      icon: "🐋",
      title: "Whale Wallets",
      desc: "Track top 1000 whale wallets",
      badge: "Signal",
    },
    {
      icon: "💸",
      title: "Large Transfers",
      desc: "Alerts on $1M+ transfers",
      badge: "Alert",
    },
    {
      icon: "🏦",
      title: "Exchange Flows",
      desc: "Whale exchange deposits/withdrawals",
      badge: "Flow",
    },
    {
      icon: "🤖",
      title: "AI Pattern",
      desc: "AI detects whale patterns",
      badge: "Smart",
    },
    {
      icon: "📊",
      title: "History",
      desc: "Whale movement history",
      badge: "Context",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 whale tracker",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Track whale wallets · Large transfers · Exchange flows · AI
        </p>
      </div>
