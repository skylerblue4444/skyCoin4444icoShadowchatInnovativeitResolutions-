      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Advanced multi-chain wallet with hardware wallet support, DeFi
            integration, and AI security
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">
          Multi-Chain Wallet V2
        </Badge>
      </div>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("Wallet V2 activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Opening Wallet V2 docs...")}
          >
