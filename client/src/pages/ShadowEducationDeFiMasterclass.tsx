  ...
  const items = [
    {
      icon: "🌊",
      title: "Yield Farming",
      desc: "Master yield farming strategies",
      badge: "Skill",
    },
    {
      icon: "💧",
      title: "Liquidity",
      desc: "Provide liquidity profitably",
      badge: "Skill",
    },
    {
      icon: "🛡️",
    ...
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Read DeFi analytics",
      badge: "Data",
    },
    {
      icon: "🏆",
      title: "Certificate",
      desc: "DeFi masterclass certificate",
      badge: "Credible",
    },
    {
      icon: "💰",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Complete DeFi education · Yield farming · Liquidity · Risk
        </p>
      </div>
