  ...
  const items = [
    {
      icon: "🔍",
      title: "Breakouts",
      desc: "Find coins breaking out",
      badge: "Opportunity",
    },
    {
      icon: "📊",
      title: "Volume Spike",
      desc: "Unusual volume detection",
      badge: "Signal",
    },
    {
      icon: "📈",
      title: "Patterns",
      desc: "Head shoulders triangles",
      badge: "Technical",
    },
    {
      icon: "🔔",
      title: "Alerts",
      desc: "Instant scanner alerts",
      badge: "First",
    },
    {
      icon: "⚡",
      title: "Real-Time",
      desc: "Updates every second",
      badge: "Live",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 always scanned",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Scan for breakouts · Volume spikes · Pattern detection
        </p>
      </div>
