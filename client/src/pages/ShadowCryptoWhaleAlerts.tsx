  ...
  const items = [
    {
      icon: "🐋",
      title: "Whale Txns",
      desc: "Transactions over $1M",
      badge: "Big",
    },
    {
      icon: "🔔",
      title: "Real-Time",
      desc: "Alerts as they happen",
      badge: "Instant",
    },
    {
      icon: "👛",
      title: "Wallet Track",
      desc: "Track specific wallets",
      badge: "Custom",
    },
    {
      icon: "🏦",
      title: "Exchange",
      desc: "Exchange inflow outflow",
      badge: "Signal",
    },
    {
      icon: "📊",
      title: "History",
      desc: "Whale activity history",
      badge: "Pattern",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 whale tracking",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Real-time whale transactions · Wallet tracking · Exchange flows
        </p>
      </div>
