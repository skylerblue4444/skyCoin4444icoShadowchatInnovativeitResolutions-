  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🛡️ Cyber Insurance</h1>
          <p className="text-sm text-muted-foreground">
            Cyber liability insurance for Arkansas businesses — data breach,
            ransomware, and business interruption coverage
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Protection</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-green-400"}>247</p>
            <p className="text-xs text-muted-foreground">Policies Written</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">4M</p>
            <p className="text-xs text-muted-foreground">Total Coverage</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">,847/yr</p>
            <p className="text-xs text-muted-foreground">Avg Premium</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">.4M</p>
