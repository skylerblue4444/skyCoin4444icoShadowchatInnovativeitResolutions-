...
export default function ShadowLanguageSettings() {
  const items = [
    ...
    },
    {
      icon: "🇨🇳",
      title: "Chinese",
      desc: "Full Mandarin support",
      badge: "Global",
    },
    {
      icon: "🇪🇸",
      title: "Spanish",
      desc: "Full Spanish support",
      badge: "Large",
    },
    {
      icon: "🇯🇵",
      title: "Japanese",
      desc: "Full Japanese support",
      badge: "Active",
    },
    {
      icon: "🇰🇷",
      title: "Korean",
      desc: "Full Korean support",
      badge: "Crypto",
    },
    {
      icon: "🌍",
      title: "More",
      desc: "Arabic French German +4",
      badge: "Expanding",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          ShadowChat in 10 languages · Auto-detect · RTL support
        </p>
      </div>
