  ...
  const items = [
    {
      icon: "📰",
      title: "Real-Time",
      desc: "Analyzes news as it breaks",
      badge: "Instant",
    },
    {
      icon: "😊",
      title: "Sentiment",
      desc: "Positive negative neutral score",
      badge: "Clear",
    },
    {
      icon: "💥",
      title: "Impact Score",
      desc: "1-10 market impact rating",
      badge: "Prioritized",
    },
    {
      icon: "🎯",
      title: "Trade Signal",
      desc: "Buy sell hold recommendation",
      badge: "Actionable",
    },
    {
      icon: "🌍",
      title: "Global",
      desc: "News from 50+ sources",
      badge: "Comprehensive",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Real-time news sentiment · Impact scoring · Trade signals
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Turn news into trades automatically.
          </p>
