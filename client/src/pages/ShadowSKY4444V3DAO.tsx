  ...
  const items = [
    {
      icon: "🏛️",
      title: "On-Chain",
      desc: "All votes on blockchain",
      badge: "Transparent",
    },
    {
      icon: "⏰",
      title: "Timelock",
      desc: "48-hour execution delay",
      badge: "Safe",
    },
    {
      icon: "🔐",
      title: "Multi-Sig",
      desc: "Multi-signature treasury",
      badge: "Secure",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "🗳️",
      title: "Quadratic",
      desc: "Quadratic voting option",
      badge: "Fair",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 = governance power",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Fully on-chain governance · Timelock · Multi-sig · Transparent
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The most transparent DAO in crypto.
          </p>
