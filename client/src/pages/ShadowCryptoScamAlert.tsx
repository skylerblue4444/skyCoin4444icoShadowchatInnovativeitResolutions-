  ...
  const items = [
    {
      icon: "🚨",
      title: "Real-Time",
      desc: "Live scam alerts",
      badge: "Instant",
    },
    {
      icon: "🪤",
      title: "Rug Pulls",
      desc: "Detect rug pulls early",
      badge: "Warning",
    },
    {
      icon: "🎣",
      title: "Phishing",
      desc: "Phishing site detection",
      badge: "Protected",
    },
    {
      icon: "📊",
      title: "Scam Database",
      desc: "Database of known scams",
      badge: "Reference",
    },
    {
      icon: "🔔",
      title: "Alerts",
      desc: "Alert before you transact",
      badge: "First",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 scam protection",
      badge: "Safe",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Real-time scam alerts · Rug pull detection · Stay safe
        </p>
      </div>
