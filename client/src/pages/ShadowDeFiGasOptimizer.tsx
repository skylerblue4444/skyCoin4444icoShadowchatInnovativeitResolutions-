  ...
  const items = [
    {
      icon: "⛽",
      title: "Gas Predict",
      desc: "Predict gas prices 1 hour ahead",
      badge: "Smart",
    },
    {
      icon: "⏰",
      title: "Best Time",
      desc: "Best time to transact",
      badge: "Optimal",
    },
    {
      icon: "💰",
      title: "Save Fees",
      desc: "Average 40% gas savings",
      badge: "Save",
    },
    {
      icon: "📊",
      title: "Gas History",
      desc: "Historical gas price data",
      badge: "Context",
    },
    {
      icon: "🔔",
      title: "Gas Alert",
      desc: "Alert when gas is low",
      badge: "Timely",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Optimize SKY4444 gas fees",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Predict gas prices · Best time to transact · Save on fees
        </p>
      </div>
