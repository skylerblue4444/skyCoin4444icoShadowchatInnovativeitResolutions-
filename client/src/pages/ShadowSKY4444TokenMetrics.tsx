...
export default function ShadowSKY4444TokenMetrics() {
  ...
  const items = [
    ...
    },
    {
      icon: "🔒",
      title: "Locked Supply",
      desc: "Team and investor lockups",
      badge: "Vesting",
    },
    {
      icon: "🔥",
      title: "Burned",
      desc: "Total SKY4444 burned forever",
      badge: "Deflationary",
    },
    {
      icon: "💰",
      title: "Market Cap",
      desc: "Real-time market cap",
      badge: "Value",
    },
    {
      icon: "👥",
      title: "Holders",
      desc: "Number of SKY4444 holders",
      badge: "Adoption",
    },
    {
      icon: "📈",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Supply circulating locked burned · Market cap · Holders
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Complete SKY4444 token transparency.
          </p>
