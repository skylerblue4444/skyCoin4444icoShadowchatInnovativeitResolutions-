  ...
  const items = [
    {
      icon: "💼",
      title: "Jobs Created",
      desc: "Jobs created by ShadowChat",
      badge: "Employment",
    },
    {
      icon: "🎓",
      title: "Educated",
      desc: "People educated about crypto",
      badge: "Knowledge",
    },
    {
      icon: "🌍",
      title: "Countries",
      desc: "Countries using ShadowChat",
      badge: "Global",
    },
    {
      icon: "💰",
      title: "Value Created",
      desc: "Economic value created",
      badge: "Impact",
    },
    {
      icon: "🏘️",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 distributed to users",
      badge: "Distributed",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Jobs created · Communities served · Crypto educated · Arkansas
        </p>
      </div>
