  ...
  const items = [
    {
      icon: "📧",
      title: "Gmail",
      desc: "Business Gmail setup",
      badge: "Communication",
    },
    {
      icon: "📁",
      title: "Drive",
      desc: "Google Drive deployment",
      badge: "Storage",
    },
    {
      icon: "📝",
      title: "Docs",
      desc: "Google Docs collaboration",
      badge: "Productivity",
    },
    {
      icon: "🎓",
      title: "Training",
      desc: "Staff training included",
      badge: "Supported",
    },
    {
      icon: "🔄",
      title: "Migration",
      desc: "Migrate from old email",
      badge: "Smooth",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Gmail Drive Docs deployment · Training · Migration · Arkansas
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Get your team on Google Workspace.
          </p>
