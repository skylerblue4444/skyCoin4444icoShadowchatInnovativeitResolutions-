...
export default function ShadowPlatformV2Status() {
  ...
  const items = [
    ...
    },
    {
      icon: "⛏️",
      title: "Mining",
      desc: "Mining service status",
      badge: "Core",
    },
    {
      icon: "💰",
      title: "Trading",
      desc: "Trading engine status",
      badge: "Core",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Analytics service status",
      badge: "Data",
    },
    {
      icon: "📅",
      title: "History",
      desc: "90-day uptime history",
      badge: "Transparent",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Real-time platform health · Uptime · Incidents · History
        </p>
      </div>
