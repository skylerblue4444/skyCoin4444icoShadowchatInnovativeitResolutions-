  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">💎 SKY4444 Token Hub</h1>
          <p className="text-sm text-muted-foreground">
            The official SKY4444 token dashboard — price, supply, holders,
            utility, and buy/sell directly
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Official</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-cyan-400"}>$0.047</p>
