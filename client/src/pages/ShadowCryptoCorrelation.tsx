  ...
  const items = [
    {
      icon: "📊",
      title: "Correlation",
      desc: "0 to 1 correlation scores",
      badge: "Quantified",
    },
    {
      icon: "🎨",
      title: "Heatmap",
      desc: "Visual correlation matrix",
      badge: "Clear",
    },
    {
      icon: "📈",
      title: "Historical",
      desc: "30/90/365-day correlation",
      badge: "Time",
    },
    {
      icon: "💼",
      title: "Portfolio",
      desc: "Optimize diversification",
      badge: "Smart",
    },
    {
      icon: "🔍",
      title: "Pairs",
      desc: "Find uncorrelated pairs",
      badge: "Diversify",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 correlation data",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          See how coins move together · Diversify smarter
        </p>
      </div>
