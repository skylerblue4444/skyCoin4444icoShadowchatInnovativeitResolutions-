...
export default function ShadowITLegal() {
  ...
  const items = [
    ...
    },
    {
      icon: "👤",
      title: "Client Portal",
      desc: "Client self-service portal",
      badge: "Service",
    },
    {
      icon: "🔐",
      title: "Confidential",
      desc: "Attorney-client privilege IT",
      badge: "Secure",
    },
    {
      icon: "⚖️",
      title: "Compliance",
      desc: "Bar association compliance",
      badge: "Required",
    },
    {
      icon: "💻",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Legal IT · Document management · Client portal · Arkansas
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            IT that protects attorney-client privilege.
          </p>
