  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🎨 SkyBlue NFT Collection</h1>
          <p className="text-sm text-muted-foreground">
            The official Skyler Blue IT Resolutions NFT collection — exclusive
            digital art with real-world IT service perks
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Exclusive</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-cyan-400"}>4,444</p>
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">IT Discounts</p>
