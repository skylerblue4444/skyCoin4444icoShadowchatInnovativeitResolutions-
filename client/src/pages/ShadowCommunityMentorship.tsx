  ...
  const items = [
    {
      icon: "🎓",
      title: "Get Mentor",
      desc: "Match with experienced trader",
      badge: "Learn",
    },
    {
      icon: "👨‍🏫",
      title: "Be Mentor",
      desc: "Teach and earn SKY4444",
      badge: "Teach",
    },
    {
      icon: "🤝",
      title: "1-on-1",
      desc: "Private mentorship sessions",
      badge: "Personal",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "🏆",
      title: "Certification",
      desc: "Mentorship completion cert",
      badge: "Credible",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Earn SKY4444 for mentoring",
      badge: "Incentive",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Get matched with a crypto mentor · 1-on-1 · SKY4444 rewards
        </p>
      </div>
