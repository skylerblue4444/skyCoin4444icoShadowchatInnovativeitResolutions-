  ...
  const items = [
    {
      icon: "📈",
      title: "Fractional",
      desc: "Buy $1 of any stock",
      badge: "Accessible",
    },
    {
      icon: "🕐",
      title: "24/7",
      desc: "Trade stocks anytime",
      badge: "Always",
    },
    {
      icon: "🌍",
      title: "Global",
      desc: "Access any market anywhere",
      badge: "Universal",
    },
    {
      icon: "🔐",
      title: "Custodied",
      desc: "Regulated custodian holds assets",
      badge: "Safe",
    },
    {
      icon: "💰",
      title: "Dividends",
      desc: "Receive dividends on-chain",
      badge: "Income",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Buy stocks with SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Fractional stocks on-chain · 24/7 trading · Global access
        </p>
      </div>
