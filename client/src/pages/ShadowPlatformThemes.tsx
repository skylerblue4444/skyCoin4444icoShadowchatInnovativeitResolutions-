...
export default function ShadowPlatformThemes() {
  ...
  const items = [
    ...
    },
    {
      icon: "🟡",
      title: "Gold Rush",
      desc: "SKY4444 gold theme",
      badge: "Branded",
    },
    {
      icon: "🔴",
      title: "Red Alert",
      desc: "High contrast red theme",
      badge: "Bold",
    },
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Customize your ShadowChat look · 10 themes · Custom colors
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Make ShadowChat look exactly how you want.
          </p>
