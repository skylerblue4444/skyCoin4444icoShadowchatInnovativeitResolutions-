  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🖼️ NFT Market 2.0</h1>
          <p className="text-sm text-muted-foreground">
            Advanced NFT marketplace with AI rarity scoring, price prediction,
            and portfolio optimization
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Next Gen</Badge>
      </div>
