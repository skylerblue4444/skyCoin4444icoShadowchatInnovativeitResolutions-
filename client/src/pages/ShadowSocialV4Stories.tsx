  ...
  const items = [
    {
      icon: "⏰",
      title: "24 Hours",
      desc: "Stories disappear in 24 hours",
      badge: "Ephemeral",
    },
    {
      icon: "⛏️",
      title: "Mining Wins",
      desc: "Share your mining rewards",
      badge: "Celebrate",
    },
    {
      icon: "🛒",
      title: "Shop Deals",
      desc: "Share shop finds",
      badge: "Commerce",
    },
    {
      icon: "📊",
      title: "Price Alerts",
      desc: "Share price movements",
      badge: "Inform",
    },
    {
      icon: "🎨",
      title: "Stickers",
      desc: "Crypto-themed stickers",
      badge: "Fun",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Earn SKY4444 for views",
      badge: "Incentive",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          24-hour stories · Crypto updates · Mining wins · Shop deals
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Share your crypto life in stories.
          </p>
