...
export default function ShadowMSPBackup() {
  ...
  const items = [
    ...
    },
    {
      icon: "☁️",
      title: "Cloud Copy",
      desc: "Off-site cloud backup",
      badge: "Safe",
    },
    {
      icon: "💿",
      title: "Local Copy",
      desc: "On-site backup appliance",
      badge: "Fast",
    },
    {
      icon: "⚡",
      title: "Instant Recovery",
      desc: "Restore in under 1 hour",
      badge: "Quick",
    },
    {
      icon: "🧪",
      title: "Monthly Test",
      desc: "Test restores monthly",
      badge: "Verified",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Automated backup · 3-2-1 rule · Instant recovery · Arkansas
        </p>
      </div>
