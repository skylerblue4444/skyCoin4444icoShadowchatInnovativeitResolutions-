  ...
  const items = [
    {
      icon: "🤖",
      title: "AI Feed",
      desc: "Personalized AI-curated feed",
      badge: "Smart",
    },
    {
      icon: "⏰",
      title: "Chronological",
      desc: "See everything in order",
      badge: "Fair",
    },
    {
      icon: "💰",
    ...
    },
    {
      icon: "🛡️",
      title: "Moderated",
      desc: "AI removes harmful content",
      badge: "Safe",
    },
    {
      icon: "🔥",
      title: "Trending",
      desc: "See what is trending now",
      badge: "Current",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 tipping built in",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Algorithmic and chronological · AI moderation · Earn SKY4444
        </p>
      </div>
