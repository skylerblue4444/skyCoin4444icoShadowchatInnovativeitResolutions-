      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Trade SKY4444 on ShadowChat DEX with deep liquidity and zero
            platform fees
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">4.4M USD</p>
            <p className="text-xs text-muted-foreground">Liquidity</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">44+</p>
            <p className="text-xs text-muted-foreground">Pairs</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">0pct platform</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-yellow-900/40 to-orange-900/40 border border-yellow-500/30 p-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("SKY4444 Exchange activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Opening SKY4444 Exchange docs...")}
          >
