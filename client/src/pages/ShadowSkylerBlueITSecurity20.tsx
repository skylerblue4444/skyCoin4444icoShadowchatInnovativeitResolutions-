  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🔐 Privileged Access Mgmt</h1>
          <p className="text-sm text-muted-foreground">
            Privileged access management for Arkansas businesses — control,
            monitor, and audit privileged accounts
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">PAM</Badge>
      </div>
