  ...
  const items = [
    {
      icon: "⛏️",
      title: "Top Miners",
      desc: "Highest hash rate miners",
      badge: "Compete",
    },
    {
      icon: "📊",
      title: "Top Traders",
      desc: "Highest trading volume",
      badge: "Compete",
    },
    {
      icon: "💰",
      title: "Top Earners",
      desc: "Most SKY4444 earned",
      badge: "Compete",
    },
    {
      icon: "👥",
      title: "Top Referrers",
      desc: "Most referrals sent",
      badge: "Compete",
    },
    {
      icon: "🏆",
      title: "Weekly Prizes",
      desc: "Top 10 win SKY4444",
      badge: "Win",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "All prizes in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Top miners traders earners referrers · Win SKY4444 prizes
        </p>
      </div>
