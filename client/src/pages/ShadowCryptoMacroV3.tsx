  ...
  const items = [
    {
      icon: "🏦",
      title: "Fed Rates",
      desc: "Federal Reserve rate tracker",
      badge: "Macro",
    },
    {
      icon: "💵",
      title: "DXY",
      desc: "US Dollar index correlation",
      badge: "FX",
    },
    {
      icon: "🥇",
    ...
    },
    {
      icon: "🛢️",
      title: "Oil",
      desc: "Oil price macro impact",
      badge: "Commodity",
    },
    {
      icon: "🌍",
      title: "Global Liquidity",
      desc: "M2 global liquidity tracker",
      badge: "Fundamental",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 macro correlation",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Fed rates DXY gold oil BTC correlation · Global liquidity
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Understand the macro forces driving crypto.
          </p>
