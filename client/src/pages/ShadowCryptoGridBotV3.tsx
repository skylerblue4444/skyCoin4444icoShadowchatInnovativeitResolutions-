  ...
  const items = [
    {
      icon: "📊",
      title: "Grid Trading",
      desc: "Profit from price oscillation",
      badge: "Strategy",
    },
    {
      icon: "🤖",
      title: "AI Grid",
      desc: "AI sets optimal grid levels",
      badge: "Smart",
    },
    {
      icon: "📈",
      title: "Backtest",
      desc: "Backtest grid strategies",
      badge: "Validate",
    },
    {
      icon: "💰",
      title: "Profit",
      desc: "Earn from every price swing",
      badge: "Income",
    },
    {
      icon: "🔄",
      title: "Auto-Adjust",
      desc: "Auto-adjust grid to market",
      badge: "Adaptive",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Grid trade SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Grid trading · Profit from volatility · Auto-set · AI grid
        </p>
      </div>
