  ...
  const items = [
    {
      icon: "🇳🇬",
      title: "Nigeria",
      desc: "Nigeria crypto market overview",
      badge: "Regional",
    },
    {
      icon: "💰",
      title: "NGN Pairs",
      desc: "Naira trading pairs",
      badge: "Local",
    },
    {
      icon: "🤝",
      title: "P2P",
      desc: "Strong P2P crypto market",
      badge: "Active",
    },
    {
      icon: "📊",
      title: "Market",
      desc: "Nigeria crypto market data",
      badge: "Informed",
    },
    {
      icon: "🔄",
      title: "On-Ramp",
      desc: "NGN to crypto on-ramp",
      badge: "Access",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 Nigeria market",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Nigeria crypto regulations · NGN trading pairs · P2P market
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Your gateway to Nigeria's crypto market.
          </p>
