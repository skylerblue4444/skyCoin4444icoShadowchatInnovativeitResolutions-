  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🚀 Project Launchpad</h1>
          <p className="text-sm text-muted-foreground">
            Launch your crypto project on ShadowChat — IDO, IEO, NFT drops, and
            token sales with built-in community
          </p>
        </div>
