  ...
  const items = [
    {
      icon: "🔔",
      title: "Smart",
      desc: "AI-prioritized notifications",
      badge: "Relevant",
    },
    {
      icon: "🔇",
      title: "DND",
      desc: "Do not disturb scheduling",
      badge: "Peaceful",
    },
    {
      icon: "📋",
      title: "Digest",
      desc: "Daily digest option",
      badge: "Summary",
    },
    {
      icon: "📱",
    ...
    },
    {
      icon: "🎯",
      title: "Custom",
      desc: "Custom notification rules",
      badge: "Yours",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Smart notifications · Priority filter · Digest · Do Not Disturb
        </p>
      </div>
