...
export default function ShadowPlatformV2Press() {
  ...
  const items = [
    ...
    },
    {
      icon: "🎨",
      title: "Media Kit",
      desc: "Logos colors brand assets",
      badge: "Brand",
    },
    {
      icon: "📺",
      title: "Coverage",
      desc: "Media coverage tracker",
      badge: "Visibility",
    },
    {
      icon: "📧",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Press releases · Media kit · Coverage · Contact press team
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The ShadowChat story is worth telling.
          </p>
