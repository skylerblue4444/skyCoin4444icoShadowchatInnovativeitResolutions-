  ...
  const items = [
    {
      icon: "🖨️",
      title: "Printers",
      desc: "Managed printer fleet",
      badge: "Covered",
    },
    {
      icon: "📄",
      title: "Toner",
      desc: "Auto-toner replenishment",
      badge: "Never Empty",
    },
    {
      icon: "📡",
      title: "Remote Monitor",
      desc: "Remote printer monitoring",
      badge: "Proactive",
    },
    {
      icon: "🔧",
      title: "Service",
      desc: "On-site printer service",
      badge: "Fast",
    },
    {
      icon: "💰",
      title: "Cost Reduce",
      desc: "Reduce print costs 30%",
      badge: "Save",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Printers copiers scanners · Toner · Remote monitoring · AR
        </p>
      </div>
