...
export default function ShadowMSPEndpoint() {
  ...
  const items = [
    ...
    },
    {
      icon: "🔐",
      title: "Encryption",
      desc: "BitLocker FileVault encryption",
      badge: "Safe",
    },
    {
      icon: "📱",
      title: "Remote Wipe",
      desc: "Wipe lost devices instantly",
      badge: "Control",
    },
    {
      icon: "🔍",
      title: "Threat Hunt",
      desc: "Proactive threat hunting",
      badge: "Proactive",
    },
    {
      icon: "📊",
      title: "Reports",
      desc: "Security posture reports",
      badge: "Aware",
    },
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Antivirus EDR · Remote wipe · Encryption · Arkansas
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Protect every endpoint in your business.
          </p>
