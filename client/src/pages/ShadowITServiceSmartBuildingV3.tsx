  ...
  const items = [
    {
      icon: "🌡️",
      title: "IoT Sensors",
      desc: "Building IoT sensor network",
      badge: "Smart",
    },
    {
      icon: "⚡",
    ...
    },
    {
      icon: "🔑",
      title: "Access",
      desc: "Smart access control",
      badge: "Secure",
    },
    {
      icon: "🤖",
      title: "Automation",
      desc: "Building automation platform",
      badge: "Automated",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Building performance analytics",
      badge: "Informed",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          IoT sensors · Energy management · Access control · Automation
        </p>
      </div>
