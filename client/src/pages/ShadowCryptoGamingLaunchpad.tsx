  ...
  const items = [
    {
      icon: "🚀",
      title: "Early Access",
      desc: "Get in before public launch",
      badge: "First",
    },
    {
      icon: "💰",
      title: "IDO",
      desc: "Initial game offering",
      badge: "Invest",
    },
    {
      icon: "🎮",
      title: "Demo",
      desc: "Play demos before investing",
      badge: "Try",
    },
    {
      icon: "📊",
      title: "Metrics",
      desc: "Player count revenue data",
      badge: "Research",
    },
    {
      icon: "🏆",
      title: "Whitelist",
      desc: "Apply for whitelist spots",
      badge: "Exclusive",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Invest with SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Discover and invest in new crypto games before launch
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Find the next big crypto game early.
          </p>
