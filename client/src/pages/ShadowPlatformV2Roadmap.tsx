...
export default function ShadowPlatformV2Roadmap() {
  ...
  const items = [
    ...
    },
    {
      icon: "Q3 2025",
      title: "Q3 2025",
      desc: "SKY4444 exchange listing",
      badge: "Big",
    },
    {
      icon: "Q4 2025",
      title: "Q4 2025",
      desc: "Enterprise platform launch",
      badge: "Scale",
    },
    {
      icon: "Q1 2026",
      title: "Q1 2026",
      desc: "Global expansion 50 countries",
      badge: "Global",
    },
    {
      icon: "2026",
      title: "2026",
      desc: "$1B platform valuation",
      badge: "Vision",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 at center of it all",
      badge: "Core",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          What we're building next · Quarters · Milestones · Vision
        </p>
      </div>
