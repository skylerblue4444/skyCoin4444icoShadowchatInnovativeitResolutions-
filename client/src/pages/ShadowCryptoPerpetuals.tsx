  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">♾️ Perpetual Futures</h1>
          <p className="text-sm text-muted-foreground">
            Trade crypto perpetual futures with up to 125x leverage — no expiry,
            funding rates, and deep liquidity
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-orange-400"}>.4B</p>
            <p className="text-xs text-muted-foreground">Open Interest</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">2.7B</p>
            <p className="text-xs text-muted-foreground">24h Volume</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">125x</p>
            <p className="text-xs text-muted-foreground">Max Leverage</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">0.01%</p>
