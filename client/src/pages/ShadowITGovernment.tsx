...
export default function ShadowITGovernment() {
  ...
  const items = [
    ...
    },
    {
      icon: "📊",
      title: "Reporting",
      desc: "Audit-ready reporting",
      badge: "Compliant",
    },
    {
      icon: "🌐",
      title: "E-Gov",
      desc: "Digital government services",
      badge: "Modern",
    },
    {
      icon: "💻",
      title: "Workstations",
      desc: "Government workstation mgmt",
      badge: "Managed",
    },
    {
      icon: "📞",
      title: "Contract",
      desc: "479-406-7123 for contract",
      badge: "Contact",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Government IT · FedRAMP · CJIS · Arkansas municipalities
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Trusted IT for Arkansas government.
          </p>
