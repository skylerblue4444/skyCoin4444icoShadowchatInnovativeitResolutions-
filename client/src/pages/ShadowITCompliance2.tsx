    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Automated IT compliance management for HIPAA, PCI-DSS, SOC2, and ISO
            27001
          </p>
        </div>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">
          IT Compliance 2.0 — Activate Now
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("IT Compliance 2.0 activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Opening IT Compliance 2.0 docs...")}
          >
