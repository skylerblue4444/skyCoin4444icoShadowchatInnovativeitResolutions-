  ...
  const items = [
    {
      icon: "🇮🇳",
      title: "India",
      desc: "India crypto market overview",
      badge: "Regional",
    },
    {
      icon: "💰",
      title: "INR Pairs",
      desc: "Rupee trading pairs",
      badge: "Local",
    },
    {
      icon: "📋",
      title: "Regulations",
      desc: "India crypto tax and rules",
      badge: "Compliant",
    },
    {
      icon: "📊",
      title: "Market",
      desc: "India crypto market data",
      badge: "Informed",
    },
    {
      icon: "🔄",
      title: "UPI",
      desc: "UPI to crypto on-ramp",
      badge: "Access",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 India market",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          India crypto regulations · INR trading pairs · UPI on-ramp
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Your gateway to India's crypto market.
          </p>
