...
export default function ShadowITAutomationWorkflow() {
  ...
  const items = [
    ...
    },
    {
      icon: "⚡",
      title: "Fast",
      desc: "Workflows run in milliseconds",
      badge: "Quick",
    },
    {
      icon: "📊",
      title: "Monitor",
      desc: "Monitor all running workflows",
      badge: "Visible",
    },
    {
      icon: "📞",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Connect your apps · Automate workflows · Zapier alternative
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Connect your business apps automatically.
          </p>
