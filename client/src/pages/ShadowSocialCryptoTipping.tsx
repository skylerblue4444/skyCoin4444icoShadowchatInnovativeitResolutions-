  ...
  const items = [
    {
      icon: "💰",
      title: "Tip Anyone",
      desc: "Tip any creator instantly",
      badge: "Easy",
    },
    {
      icon: "⚡",
      title: "Micro-Payments",
      desc: "Tips as small as $0.01",
      badge: "Accessible",
    },
    {
      icon: "🪙",
      title: "Any Crypto",
      desc: "BTC ETH SKY4444 DOGE",
      badge: "Flexible",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Track your tipping history",
      badge: "Visible",
    },
    {
      icon: "🏆",
      title: "Top Tippers",
      desc: "Leaderboard of top tippers",
      badge: "Recognition",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 tipping preferred",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Tip anyone in any crypto · Micro-payments · Creator economy
        </p>
      </div>
