...
export default function ShadowWeb3SocialV2Nostr() {
  ...
  const items = [
    ...
    },
    {
      ...
      desc: "No one can ban you",
      badge: "Open",
    },
    {
      icon: "⚡",
      title: "Zaps",
      desc: "Bitcoin lightning tips",
      badge: "Native",
    },
    {
      icon: "🔌",
      title: "Relays",
      desc: "Connect to any relay",
      badge: "Flexible",
    },
    {
      icon: "🔑",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Decentralized social · Censorship resistant · Zaps · Relays
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The truly censorship-resistant social network.
          </p>
