  ...
  const items = [
    {
      ...
      desc: "Verified profitable traders",
      badge: "Qualified",
    },
    {
      icon: "📅",
      title: "Book Session",
      desc: "1-on-1 video calls",
      badge: "Personal",
    },
    {
      icon: "💰",
      title: "Pay SKY4444",
      desc: "Sessions paid in SKY4444",
      badge: "Native",
    },
    {
      icon: "📊",
      title: "Track Record",
      desc: "See mentor performance",
      badge: "Transparent",
    },
    {
      icon: "🎯",
    ...
    },
    {
      icon: "🏆",
      title: "Certification",
      desc: "Mentor-signed certificate",
      badge: "Credible",
    },
  ];
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Learn from expert traders · 1-on-1 sessions · SKY4444
        </p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Learn from the best traders in crypto.
          </p>
