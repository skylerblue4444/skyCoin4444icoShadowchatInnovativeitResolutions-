    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            AI-powered NFT rarity scoring with trait analysis, floor prediction,
            and alpha alerts
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className={"font-black text-lg text-violet-400"}>24M</p>
            <p className="text-xs text-muted-foreground">NFTs Analyzed</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">97.3%</p>
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-orange-400">8,247</p>
            <p className="text-xs text-muted-foreground">Alpha Calls</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">
          NFT Rarity AI — Get Started Today
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActivated(true);
              toast.success(
                "NFT Rarity AI activated! Enjoy your new features."
              );
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("Opening NFT Rarity AI documentation...")}
          >
