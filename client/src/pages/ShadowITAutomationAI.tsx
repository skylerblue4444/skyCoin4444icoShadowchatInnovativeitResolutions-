  ...
  const items = [
    {
      ...
      desc: "Describe tasks in plain English",
      badge: "Easy",
    },
    {
      icon: "🤖",
      title: "Self-Learning",
      desc: "AI improves over time",
      badge: "Smart",
    },
    {
      icon: "🔄",
      title: "Any Process",
      desc: "Automate any business process",
      badge: "Universal",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "Track automation performance",
      badge: "Visible",
    },
    {
      icon: "💰",
      title: "ROI",
      desc: "Average 300% ROI in year 1",
      badge: "Profitable",
    },
    {
      icon: "📞",
      title: "Build",
      desc: "479-406-7123 to build",
      badge: "Contact",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          AI-powered automation · Natural language · Self-learning
        </p>
      </div>
