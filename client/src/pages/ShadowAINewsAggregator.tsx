  ...
  const items = [
    {
      icon: "📰",
      title: "All Sources",
      desc: "1000+ news sources aggregated",
      badge: "Complete",
    },
    {
      icon: "🤖",
      title: "AI Summary",
      desc: "AI summarizes every article",
      badge: "Quick",
    },
    {
      icon: "😊",
    ...
    },
    {
      icon: "🔍",
      title: "Filter",
      desc: "Filter by coin topic source",
      badge: "Relevant",
    },
    {
      icon: "🔔",
      title: "Alerts",
      desc: "Alert on breaking news",
      badge: "First",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          All crypto news · AI-summarized · Sentiment scored · Filtered
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Every crypto news story. Summarized by AI.
          </p>
