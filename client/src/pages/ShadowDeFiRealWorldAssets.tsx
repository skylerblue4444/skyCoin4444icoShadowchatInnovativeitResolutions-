  ...
  const items = [
    {
      icon: "🏠",
      title: "Real Estate",
      desc: "Tokenized property investment",
      badge: "Tangible",
    },
    {
      icon: "📄",
    ...
    },
    {
      icon: "🏢",
      title: "Commercial",
      desc: "Commercial real estate tokens",
      badge: "Scale",
    },
    {
      icon: "💰",
      title: "Yield",
      desc: "Real-world yield on-chain",
      badge: "Stable",
    },
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Tokenized real estate bonds commodities · On-chain RWA
        </p>
      </div>
