  ...
  const items = [
    {
      icon: "🌍",
      title: "100 Countries",
      desc: "Ambassadors worldwide",
      badge: "Global",
    },
    {
      icon: "💰",
      title: "Monthly Stipend",
      desc: "Paid in SKY4444",
      badge: "Compensated",
    },
    {
      icon: "📱",
      title: "Social Media",
      desc: "Grow local presence",
      badge: "Influence",
    },
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Global ambassadors · Local communities · SKY4444 stipend
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Lead the ShadowChat revolution in your city.
          </p>
