...
export default function ShadowWeb3SocialTipping() {
  ...
  const items = [
    ...
    { icon: "🐕", title: "DOGE Tips", desc: "Tip in DOGE", badge: "Fun" },
    {
      icon: "🇺🇸",
      title: "TRUMP Tips",
      desc: "Tip in TRUMP coin",
      badge: "Patriotic",
    },
    {
      icon: "⚡",
      title: "Instant",
      desc: "Tips arrive in seconds",
      badge: "Fast",
    },
    {
      icon: "💰",
      title: "No Fees",
      desc: "Zero fees under $1",
      badge: "Generous",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Tip anyone instantly · Multi-coin · No fees under $1
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Show appreciation with crypto tips.
          </p>
