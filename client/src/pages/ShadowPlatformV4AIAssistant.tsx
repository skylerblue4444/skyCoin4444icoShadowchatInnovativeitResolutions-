...
export default function ShadowPlatformV4AIAssistant() {
  ...
  const items = [
    ...
    },
    {
      icon: "⚡",
      title: "Execute",
      desc: "AI executes trades for you",
      badge: "Powerful",
    },
    {
      icon: "📊",
      title: "Analyze",
      desc: "AI analyzes your portfolio",
      badge: "Smart",
    },
    {
      icon: "🔔",
      title: "Proactive",
      desc: "AI alerts you to opportunities",
      badge: "Helpful",
    },
    {
      icon: "🎤",
    ...
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "AI optimizes SKY4444 holdings",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Your personal crypto AI · Ask anything · Execute commands
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Your personal crypto AI that actually does things.
          </p>
