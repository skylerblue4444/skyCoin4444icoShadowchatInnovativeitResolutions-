...
export default function ShadowDeFiLiquidityV2() {
  ...
  const items = [
    ...
    },
    {
      icon: "🔄",
      title: "Auto-Compound",
      desc: "Compound LP rewards",
      badge: "Grow",
    },
    {
      icon: "📊",
      title: "Analytics",
      desc: "LP position analytics",
      badge: "Informed",
    },
    {
      icon: "🌍",
      title: "All DEXs",
      desc: "Uniswap Curve Balancer",
      badge: "Wide",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 LP management",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Manage LP positions · Impermanent loss · Auto-compound
        </p>
      </div>
