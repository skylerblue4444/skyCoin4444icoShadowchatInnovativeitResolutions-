  ...
  const items = [
    {
      icon: "📱",
      title: "iOS Android",
      desc: "Native mobile wallet app",
      badge: "Everywhere",
    },
    {
      icon: "👆",
      title: "Biometric",
      desc: "Face ID fingerprint unlock",
      badge: "Secure",
    },
    {
      icon: "💧",
      title: "DeFi Access",
      desc: "Access DeFi from wallet",
      badge: "Powerful",
    },
    {
      icon: "🎨",
      title: "NFT Gallery",
      desc: "View NFTs in wallet",
      badge: "Complete",
    },
    {
      icon: "🔄",
      title: "Swap",
      desc: "Swap tokens in wallet",
      badge: "Convenient",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          The best crypto wallet app · Biometric · DeFi · NFTs
        </p>
      </div>
