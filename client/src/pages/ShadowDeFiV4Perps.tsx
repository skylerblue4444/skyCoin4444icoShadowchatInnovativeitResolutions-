...
export default function ShadowDeFiV4Perps() {
  ...
  const items = [
    { icon: "📈", title: "Long", desc: "Go long on any asset", badge: "Bull" },
    {
      icon: "📉",
      title: "Short",
      desc: "Go short on any asset",
      badge: "Bear",
    },
    {
      icon: "⚡",
      title: "50x Leverage",
      desc: "Up to 50x leverage",
      badge: "Power",
    },
    { icon: "💰", title: "Low Fees", desc: "0.05% taker fee", badge: "Cheap" },
    {
      icon: "🔐",
      title: "Self-Custody",
      desc: "Your keys your coins",
      badge: "Safe",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Pay fees in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Decentralized perpetual futures · 50x leverage · SKY4444 fees
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Trade perpetuals without giving up custody.
          </p>
