  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">🔍 Vulnerability Management</h1>
          <p className="text-sm text-muted-foreground">
            Continuous vulnerability scanning and patch management for Arkansas
            businesses — find and fix vulnerabilities automatically
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Patch Fast</Badge>
      </div>
