  ...
  const items = [
    {
      icon: "📊",
      title: "Matrix",
      desc: "Full correlation matrix",
      badge: "Complete",
    },
    {
      icon: "🔗",
      title: "Correlated",
      desc: "Find highly correlated pairs",
      badge: "Risk",
    },
    {
      icon: "🔀",
      title: "Diversify",
      desc: "Find uncorrelated assets",
      badge: "Safe",
    },
    {
      icon: "📈",
      title: "Rolling",
      desc: "30-day rolling correlation",
      badge: "Dynamic",
    },
    {
      icon: "🌍",
      title: "All Assets",
      desc: "Crypto stocks gold bonds",
      badge: "Wide",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 correlations",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Find correlated assets · Diversify your portfolio · Risk
        </p>
      </div>
