  ...
  const items = [
    {
      icon: "❓",
      title: "Daily Quiz",
      desc: "New quiz every day",
      badge: "Fresh",
    },
    {
      icon: "🏆",
      title: "Leaderboard",
      desc: "Global quiz rankings",
      badge: "Compete",
    },
    {
      icon: "💰",
      title: "Earn",
      desc: "Win SKY4444 for correct answers",
      badge: "Incentive",
    },
    {
      icon: "📚",
      title: "Learn",
      desc: "Learn while earning",
      badge: "Educational",
    },
    {
      icon: "🎯",
      title: "Categories",
      desc: "BTC DeFi NFT trading",
      badge: "Variety",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Test your knowledge · Earn SKY4444 · Daily challenges
        </p>
      </div>
