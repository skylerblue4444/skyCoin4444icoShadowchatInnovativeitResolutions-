  ...
  const items = [
    {
      icon: "📹",
      title: "Video",
      desc: "Create crypto video content",
      badge: "Visual",
    },
    {
      icon: "✍️",
      title: "Writing",
      desc: "Articles and newsletters",
      badge: "Written",
    },
    {
      icon: "🎙️",
      title: "Podcast",
      desc: "Host your crypto podcast",
      badge: "Audio",
    },
    {
      icon: "📊",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Monetize your crypto content · SKY4444 revenue share
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Get paid to create crypto content.
          </p>
