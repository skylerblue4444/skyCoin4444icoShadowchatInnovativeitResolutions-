  ...
  const items = [
    {
      icon: "🔍",
      title: "Everything",
      desc: "Search all 2000+ pages",
      badge: "Complete",
    },
    {
      icon: "🤖",
      title: "AI Semantic",
      desc: "Understand natural language queries",
      badge: "Smart",
    },
    {
      icon: "🎤",
      title: "Voice",
      desc: "Voice search support",
      badge: "Hands-free",
    },
    {
      icon: "⚡",
    ...
    },
    {
      icon: "📊",
      title: "Ranked",
      desc: "AI-ranked results",
      badge: "Relevant",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Search SKY4444 content",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Search everything · AI semantic · Voice search · Instant
        </p>
      </div>
