  ...
  const items = [
    {
      icon: "💰",
      title: "Current Rates",
      desc: "Live funding rates all perps",
      badge: "Now",
    },
    {
      icon: "📊",
      title: "Historical",
      desc: "Funding rate history",
      badge: "Context",
    },
    {
      icon: "💹",
      title: "Arbitrage",
      desc: "Funding rate arbitrage opps",
      badge: "Profit",
    },
    {
      icon: "🔮",
      title: "Predicted",
      desc: "Predicted next funding rate",
      badge: "Forward",
    },
    {
      icon: "🌍",
      title: "All Exchanges",
      desc: "Binance Bybit OKX dYdX",
      badge: "Wide",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 funding rate",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Perpetual funding rates · Arbitrage · Historical · Predictions
        </p>
      </div>
