  ...
  const items = [
    {
      icon: "⛽",
      title: "ETH Gas",
      desc: "Ethereum gas tracker",
      badge: "Live",
    },
    {
      icon: "☀️",
      title: "SOL Fees",
      desc: "Solana transaction fees",
      badge: "Live",
    },
    {
      icon: "₿",
      title: "BTC Fees",
      desc: "Bitcoin mempool fees",
      badge: "Live",
    },
    {
      icon: "🔮",
      title: "Predict",
      desc: "Predict future gas prices",
      badge: "Smart",
    },
    {
      icon: "📦",
      title: "Batch",
      desc: "Batch transactions to save gas",
      badge: "Save",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 gas optimization",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          ETH SOL BTC gas · Predict future gas · Batch transactions
        </p>
      </div>
