  ...
  const items = [
    {
      icon: "🔍",
      title: "Deep Research",
      desc: "Comprehensive coin analysis",
      badge: "Thorough",
    },
    {
      icon: "📊",
      title: "Fundamentals",
      desc: "Team tech tokenomics",
      badge: "Complete",
    },
    {
      icon: "📰",
      title: "News",
      desc: "Aggregate all news sources",
      badge: "Current",
    },
    {
      icon: "🐦",
      title: "Social",
      desc: "Social sentiment analysis",
      badge: "Pulse",
    },
    {
      icon: "📄",
      title: "Report",
      desc: "Generate full research report",
      badge: "Actionable",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 research included",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Deep research on any coin · Fundamental analysis · Reports
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Research any coin in 60 seconds.
          </p>
