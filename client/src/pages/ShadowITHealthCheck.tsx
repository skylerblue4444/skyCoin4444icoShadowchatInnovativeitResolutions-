  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Comprehensive IT health assessment for businesses — security,
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-green-400">73/100</p>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/30 to-violet-900/30 border border-indigo-500/20 p-4">
        <div className="flex items-center justify-between mb-3">
          <div>
            <p className="font-black text-sm">
              IT Health Check — Premium Access
            </p>
            <p className="text-xs text-muted-foreground">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() =>
              toast.success("IT Health Check activated! Welcome aboard.")
            }
          >
