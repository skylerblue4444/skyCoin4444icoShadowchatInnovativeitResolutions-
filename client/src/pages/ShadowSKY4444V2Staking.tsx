  ...
  const items = [
    {
      icon: "💰",
      title: "V2 Rewards",
      desc: "Higher V2 staking rewards",
      badge: "Better",
    },
    {
      icon: "💧",
      title: "Liquid Staking",
      desc: "Stake and stay liquid",
      badge: "Flexible",
    },
    {
      icon: "🔄",
    ...
    },
    {
      icon: "📊",
      title: "APY",
      desc: "Real-time V2 APY display",
      badge: "Transparent",
    },
    {
      icon: "🔐",
      title: "Secure",
      desc: "V2 staking contracts audited",
      badge: "Safe",
    },
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Enhanced staking · Liquid staking · Auto-compound · V2 rewards
        </p>
      </div>
