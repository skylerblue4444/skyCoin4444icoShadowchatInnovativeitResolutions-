...
export default function ShadowPlatformV2Onboarding() {
  ...
  const items = [
    ...
    },
    {
      icon: "🎯",
      title: "Personalized",
      desc: "Tailored to your interests",
      badge: "Custom",
    },
    {
      icon: "📚",
      title: "Guided Tour",
      desc: "Interactive platform walkthrough",
      badge: "Helpful",
    },
    {
      icon: "⛏️",
      title: "Mine First",
      desc: "Start mining in step 1",
      badge: "Immediate",
    },
    {
      icon: "👛",
    ...
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          New user experience · 60-second setup · Guided tour
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            The smoothest crypto onboarding ever.
          </p>
