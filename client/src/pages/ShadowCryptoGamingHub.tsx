  ...
  const items = [
    {
      icon: "🎮",
      title: "P2E Games",
      desc: "Play and earn SKY4444",
      badge: "Fun",
    },
    {
      icon: "🏆",
      title: "Tournaments",
      desc: "Weekly gaming tournaments",
      badge: "Compete",
    },
    {
      icon: "🎨",
      title: "NFT Items",
      desc: "Own your in-game items",
      badge: "Yours",
    },
    {
      icon: "💰",
      title: "Earn",
      desc: "Real money from gaming",
      badge: "Income",
    },
    {
      icon: "🌍",
      title: "Global",
      desc: "Players from 100 countries",
      badge: "Community",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "All rewards in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Play-to-earn · NFT games · Tournaments · SKY4444 rewards
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Gaming where you actually own everything.
          </p>
