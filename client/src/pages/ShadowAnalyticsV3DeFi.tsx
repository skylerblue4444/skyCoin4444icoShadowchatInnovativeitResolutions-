  ...
  const items = [
    {
      icon: "💧",
      title: "TVL",
      desc: "Total value locked by protocol",
      badge: "Size",
    },
    {
      icon: "💰",
      title: "Yields",
      desc: "Best yields across all DeFi",
      badge: "Opportunity",
    },
    {
      icon: "📊",
    ...
    },
    {
      icon: "👥",
      title: "Users",
      desc: "Active DeFi user growth",
      badge: "Adoption",
    },
    {
      icon: "📈",
      title: "Trends",
      desc: "DeFi trend analysis",
      badge: "Direction",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "SKY4444 DeFi analytics",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          TVL · Yields · Protocol revenue · User growth · Trends
        </p>
      </div>
