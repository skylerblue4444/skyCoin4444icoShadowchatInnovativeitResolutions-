  ...
  const items = [
    {
      icon: "⚔️",
      title: "Join Guild",
      desc: "Find your gaming guild",
      badge: "Community",
    },
    {
      icon: "💰",
      title: "Shared Earnings",
      desc: "Pool and share rewards",
      badge: "Together",
    },
    {
      icon: "🏆",
      title: "Guild Rank",
      desc: "Climb the guild leaderboard",
      badge: "Compete",
    },
    {
      icon: "🎓",
      title: "Training",
      desc: "Learn from guild masters",
      badge: "Improve",
    },
    {
      icon: "🌍",
      title: "Global Guilds",
      desc: "Guilds from every country",
      badge: "Worldwide",
    },
    {
      icon: "✦",
      title: "SKY4444",
      desc: "Guild treasury in SKY4444",
      badge: "Native",
    },
  ];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Join a guild · Share resources · Earn together · SKY4444
        </p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 px-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Stronger together. Earn more together.
          </p>
