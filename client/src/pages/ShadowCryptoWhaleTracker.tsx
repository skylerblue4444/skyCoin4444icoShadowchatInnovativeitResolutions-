...
export default function ShadowCryptoWhaleTracker() {
  const items = [
    ...
    { icon: "🐳", title: "Whales", desc: "Wallets $1M-$100M", badge: "Large" },
    {
      ...
      desc: "Whale deposits/withdrawals",
      badge: "Signal",
    },
    {
      icon: "🔔",
      title: "Alerts",
      desc: "Instant whale move alerts",
      badge: "First",
    },
    {
      icon: "🔍",
      title: "Wallet Analysis",
      desc: "Deep dive any wallet",
      badge: "Research",
    },
    {
      icon: "✦",
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Track wallets over $1M · Real-time alerts · Exchange flows
        </p>
      </div>
