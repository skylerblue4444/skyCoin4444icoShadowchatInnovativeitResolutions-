...
export default function ShadowAIAudit() {
  const [active, setActive] = useState(false);
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">AI Smart Contract Audit</h1>
          <p className="text-sm text-muted-foreground">
            AI-powered smart contract auditing with vulnerability detection and
            gas optimization
          </p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">AI Audit</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-lg text-blue-400">47pct avg</p>
            <p className="text-xs text-muted-foreground">Gas Optimization</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">
          AI Smart Contract Audit — Activate Now
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => {
              setActive(true);
              toast.success("AI Smart Contract Audit activated!");
            }}
          >
          ...
          <Button
            variant="outline"
            onClick={() =>
              toast.info("Opening AI Smart Contract Audit docs...")
            }
          >
